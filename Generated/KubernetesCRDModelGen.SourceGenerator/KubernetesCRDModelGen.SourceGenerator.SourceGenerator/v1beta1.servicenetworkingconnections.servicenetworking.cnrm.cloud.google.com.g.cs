...
public partial class V1beta1ServiceNetworkingConnectionList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ServiceNetworkingConnection>
{
    ...
    public string ApiVersion { get; set; } = "servicenetworking.cnrm.cloud.google.com/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ServiceNetworkingConnectionList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ServiceNetworkingConnection objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ServiceNetworkingConnection> Items { get; set; }
}
...
public partial class V1beta1ServiceNetworkingConnectionSpec
{
    ...
    public required V1beta1ServiceNetworkingConnectionSpecNetworkRef NetworkRef { get; set; }

    [JsonPropertyName("reservedPeeringRanges")]
    public required IList<V1beta1ServiceNetworkingConnectionSpecReservedPeeringRanges> ReservedPeeringRanges { get; set; }
...
public partial class V1beta1ServiceNetworkingConnection : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ServiceNetworkingConnectionSpec>, IStatus<V1beta1ServiceNetworkingConnectionStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ServiceNetworkingConnection";
    ...
    public required V1beta1ServiceNetworkingConnectionSpec Spec { get; set; }
