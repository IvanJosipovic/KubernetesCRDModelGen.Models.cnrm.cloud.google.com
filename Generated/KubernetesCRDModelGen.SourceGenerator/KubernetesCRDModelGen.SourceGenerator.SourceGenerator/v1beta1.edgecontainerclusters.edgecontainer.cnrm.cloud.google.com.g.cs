...
public partial class V1beta1EdgeContainerClusterList : IKubernetesObject<V1ListMeta>, IItems<V1beta1EdgeContainerCluster>
{
    ...
    public string Kind { get; set; } = "EdgeContainerClusterList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1EdgeContainerCluster objects.</summary>
...
public partial class V1beta1EdgeContainerClusterSpecAuthorizationAdminUsers
{
    ...
    public required V1beta1EdgeContainerClusterSpecAuthorizationAdminUsersUsernameRef UsernameRef { get; set; }
}
...
public partial class V1beta1EdgeContainerClusterSpecAuthorization
{
    ...
    public required V1beta1EdgeContainerClusterSpecAuthorizationAdminUsers AdminUsers { get; set; }
}
...
public partial class V1beta1EdgeContainerClusterSpecFleet
{
    ...
    public required V1beta1EdgeContainerClusterSpecFleetProjectRef ProjectRef { get; set; }
}
...
public partial class V1beta1EdgeContainerClusterSpecMaintenancePolicyWindow
{
    ...
    public required V1beta1EdgeContainerClusterSpecMaintenancePolicyWindowRecurringWindow RecurringWindow { get; set; }
}
...
public partial class V1beta1EdgeContainerClusterSpecMaintenancePolicy
{
    /// <summary>Specifies the maintenance window in which maintenance may be performed.</summary>
    [JsonPropertyName("window")]
    public required V1beta1EdgeContainerClusterSpecMaintenancePolicyWindow Window { get; set; }
}
...
public partial class V1beta1EdgeContainerClusterSpecNetworking
{
    ...
    public required IList<string> ClusterIpv4CidrBlocks { get; set; }
    ...
    public required IList<string> ServicesIpv4CidrBlocks { get; set; }
...
public partial class V1beta1EdgeContainerClusterSpec
{
    ...
    public required V1beta1EdgeContainerClusterSpecAuthorization Authorization { get; set; }
    ...
    public required V1beta1EdgeContainerClusterSpecFleet Fleet { get; set; }
    ...
    public required V1beta1EdgeContainerClusterSpecNetworking Networking { get; set; }

    /// <summary>The project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public required V1beta1EdgeContainerClusterSpecProjectRef ProjectRef { get; set; }
...
public partial class V1beta1EdgeContainerCluster : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1EdgeContainerClusterSpec>, IStatus<V1beta1EdgeContainerClusterStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "EdgeContainerCluster";
    ...
    public required V1beta1EdgeContainerClusterSpec Spec { get; set; }
