...
public partial class V1beta1CloudBuildTriggerList : IKubernetesObject<V1ListMeta>, IItems<V1beta1CloudBuildTrigger>
{
    ...
    public string ApiVersion { get; set; } = "cloudbuild.cnrm.cloud.google.com/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "CloudBuildTriggerList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1CloudBuildTrigger objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1CloudBuildTrigger> Items { get; set; }
}
...
{
    /// <summary>Conditions represent the latest available observations of the object&apos;s current state. Conditions represent the latest available observation of the resource&apos;s current state.</summary>
    ...
    /// <summary>A unique specifier for the CloudBuildTrigger resource in GCP.</summary>
    ...
    public V1beta1CloudBuildTriggerStatusObservedState? ObservedState { get; set; }
...
public partial class V1beta1CloudBuildTrigger : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1CloudBuildTriggerSpec>, IStatus<V1beta1CloudBuildTriggerStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "CloudBuildTrigger";
    ...
    public required V1beta1CloudBuildTriggerSpec Spec { get; set; }
