...
public partial class V1alpha1PubSubLiteSubscriptionList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1PubSubLiteSubscription>
{
    ...
    public string Kind { get; set; } = "PubSubLiteSubscriptionList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1PubSubLiteSubscription objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1PubSubLiteSubscription> Items { get; set; }
}
...
public partial class V1alpha1PubSubLiteSubscriptionSpecDeliveryConfig
{
    ...
    public required string DeliveryRequirement { get; set; }
}
...
public partial class V1alpha1PubSubLiteSubscriptionSpec
{
    ...
    public required V1alpha1PubSubLiteSubscriptionSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1PubSubLiteSubscription : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1PubSubLiteSubscriptionSpec>, IStatus<V1alpha1PubSubLiteSubscriptionStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "PubSubLiteSubscription";
    ...
    public required V1alpha1PubSubLiteSubscriptionSpec Spec { get; set; }
