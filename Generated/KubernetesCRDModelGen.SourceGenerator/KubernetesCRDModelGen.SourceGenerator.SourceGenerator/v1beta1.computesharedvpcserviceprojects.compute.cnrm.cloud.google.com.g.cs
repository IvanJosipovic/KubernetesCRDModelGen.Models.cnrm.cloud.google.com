...
/// <summary>ComputeSharedVPCServiceProject is the Schema for the compute API</summary>
...
public partial class V1beta1ComputeSharedVPCServiceProjectList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ComputeSharedVPCServiceProject>
{
    ...
    public string Kind { get; set; } = "ComputeSharedVPCServiceProjectList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ComputeSharedVPCServiceProject objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ComputeSharedVPCServiceProject> Items { get; set; }
}
...
public partial class V1beta1ComputeSharedVPCServiceProjectSpec
{
    ...
    public required V1beta1ComputeSharedVPCServiceProjectSpecProjectRef ProjectRef { get; set; }
}
...
{
    /// <summary>Conditions represent the latest available observations of the ComputeSharedVPCServiceProject&apos;s current state.</summary>
...
public partial class V1beta1ComputeSharedVPCServiceProject : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ComputeSharedVPCServiceProjectSpec>, IStatus<V1beta1ComputeSharedVPCServiceProjectStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ComputeSharedVPCServiceProject";
    ...
    public required V1beta1ComputeSharedVPCServiceProjectSpec Spec { get; set; }
