...
public partial class V1alpha1OSConfigPatchDeploymentList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1OSConfigPatchDeployment>
{
    ...
    public const string KubeKind = "OSConfigPatchDeploymentList";
    ...
    public string ApiVersion { get; set; } = "osconfig.cnrm.cloud.google.com/v1alpha1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "OSConfigPatchDeploymentList";
...
public partial class V1alpha1OSConfigPatchDeploymentSpecOneTimeSchedule
{
    ...
    public required string ExecuteTime { get; set; }
}
...
public partial class V1alpha1OSConfigPatchDeploymentSpecPatchConfigPostStepLinuxExecStepConfigGcsObject
{
    ...
    public required string GenerationNumber { get; set; }
...
public partial class V1alpha1OSConfigPatchDeploymentSpecRecurringScheduleMonthlyWeekDayOfMonth
{
    ...
    public required int WeekOrdinal { get; set; }
}
...
public partial class V1alpha1OSConfigPatchDeploymentSpecRecurringSchedule
{
    ...
    public required V1alpha1OSConfigPatchDeploymentSpecRecurringScheduleTimeOfDay TimeOfDay { get; set; }
    ...
    public required V1alpha1OSConfigPatchDeploymentSpecRecurringScheduleTimeZone TimeZone { get; set; }
...
public partial class V1alpha1OSConfigPatchDeploymentSpecRollout
{
    ...
    public required V1alpha1OSConfigPatchDeploymentSpecRolloutDisruptionBudget DisruptionBudget { get; set; }
...
public partial class V1alpha1OSConfigPatchDeploymentSpec
{
    ...
    public required V1alpha1OSConfigPatchDeploymentSpecInstanceFilter InstanceFilter { get; set; }
    ...
    public required string PatchDeploymentId { get; set; }

    /// <summary>The project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public required V1alpha1OSConfigPatchDeploymentSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1OSConfigPatchDeployment : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1OSConfigPatchDeploymentSpec>, IStatus<V1alpha1OSConfigPatchDeploymentStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "OSConfigPatchDeployment";
    ...
    public required V1alpha1OSConfigPatchDeploymentSpec Spec { get; set; }
