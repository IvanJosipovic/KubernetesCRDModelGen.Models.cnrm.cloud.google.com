...
public partial class V1alpha1ColabRuntimeList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ColabRuntime>
{
    ...
    public string Kind { get; set; } = "ColabRuntimeList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1ColabRuntime objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1ColabRuntime> Items { get; set; }
}
...
public partial class V1alpha1ColabRuntimeSpec
{
    ...
    public required V1alpha1ColabRuntimeSpecColabRuntimeTemplateRef ColabRuntimeTemplateRef { get; set; }
    ...
    public required V1alpha1ColabRuntimeSpecProjectRef ProjectRef { get; set; }
    ...
    public required string RuntimeUser { get; set; }
}
...
public partial class V1alpha1ColabRuntime : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1ColabRuntimeSpec>, IStatus<V1alpha1ColabRuntimeStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ColabRuntime";
    ...
    public required V1alpha1ColabRuntimeSpec Spec { get; set; }
