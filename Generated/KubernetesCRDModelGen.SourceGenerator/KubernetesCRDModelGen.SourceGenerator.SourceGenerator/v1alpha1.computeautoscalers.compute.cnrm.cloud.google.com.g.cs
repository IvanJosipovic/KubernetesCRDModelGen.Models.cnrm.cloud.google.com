...
public partial class V1alpha1ComputeAutoscalerList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ComputeAutoscaler>
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "ComputeAutoscalerList";
    ...
    public string Kind { get; set; } = "ComputeAutoscalerList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1ComputeAutoscaler objects.</summary>
...
public partial class V1alpha1ComputeAutoscalerSpec
{
    ...
    public required V1alpha1ComputeAutoscalerSpecAutoscalingPolicy AutoscalingPolicy { get; set; }
    ...
    public required V1alpha1ComputeAutoscalerSpecProjectRef ProjectRef { get; set; }
    ...
    public required V1alpha1ComputeAutoscalerSpecTargetRef TargetRef { get; set; }
...
public partial class V1alpha1ComputeAutoscaler : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1ComputeAutoscalerSpec>, IStatus<V1alpha1ComputeAutoscalerStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ComputeAutoscaler";
