...
public partial class V1alpha1AppEngineStandardAppVersionList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1AppEngineStandardAppVersion>
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "AppEngineStandardAppVersionList";
    ...
    public string Kind { get; set; } = "AppEngineStandardAppVersionList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1AppEngineStandardAppVersion objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1AppEngineStandardAppVersion> Items { get; set; }
}
...
public partial class V1alpha1AppEngineStandardAppVersionSpec
{
    ...
    public required V1alpha1AppEngineStandardAppVersionSpecDeployment Deployment { get; set; }

    /// <summary>The entrypoint for the application.</summary>
    [JsonPropertyName("entrypoint")]
    public required V1alpha1AppEngineStandardAppVersionSpecEntrypoint Entrypoint { get; set; }
    ...
    public required V1alpha1AppEngineStandardAppVersionSpecServiceRef ServiceRef { get; set; }
...
public partial class V1alpha1AppEngineStandardAppVersion : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1AppEngineStandardAppVersionSpec>, IStatus<V1alpha1AppEngineStandardAppVersionStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "AppEngineStandardAppVersion";
    ...
    public required V1alpha1AppEngineStandardAppVersionSpec Spec { get; set; }
