...
public partial class V1alpha1NetAppBackupPolicyList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1NetAppBackupPolicy>
{
    ...
    public string ApiVersion { get; set; } = "netapp.cnrm.cloud.google.com/v1alpha1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "NetAppBackupPolicyList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1NetAppBackupPolicy objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1NetAppBackupPolicy> Items { get; set; }
}
...
public partial class V1alpha1NetAppBackupPolicySpec
{
    ...
    public required V1alpha1NetAppBackupPolicySpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1NetAppBackupPolicy : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1NetAppBackupPolicySpec>, IStatus<V1alpha1NetAppBackupPolicyStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "NetAppBackupPolicy";
    ...
    public required V1alpha1NetAppBackupPolicySpec Spec { get; set; }
