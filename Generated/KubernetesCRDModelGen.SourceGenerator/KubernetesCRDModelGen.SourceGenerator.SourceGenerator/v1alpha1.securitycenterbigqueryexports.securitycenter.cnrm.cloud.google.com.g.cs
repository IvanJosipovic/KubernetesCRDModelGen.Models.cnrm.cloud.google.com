...
public partial class V1alpha1SecurityCenterBigQueryExportList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1SecurityCenterBigQueryExport>
{
    ...
    public const string KubeKind = "SecurityCenterBigQueryExportList";
    public const string KubeGroup = "securitycenter.cnrm.cloud.google.com";
    public const string KubePluralName = "securitycenterbigqueryexports";
    ...
    public string Kind { get; set; } = "SecurityCenterBigQueryExportList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1SecurityCenterBigQueryExport objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1SecurityCenterBigQueryExport> Items { get; set; }
}
...
{
    /// <summary>The BigQueryDataset selfLink, when not managed by Config Connector.</summary>
...
public partial class V1alpha1SecurityCenterBigQueryExportSpec
{
    ...
    public required V1alpha1SecurityCenterBigQueryExportSpecDatasetRef DatasetRef { get; set; }

    /// <summary>The description of the export (max of 1024 characters).</summary>
    [JsonPropertyName("description")]
    public string? Description { get; set; }

    /// <summary>Expression that defines the filter to apply across create/update events of findings.</summary>
    ...
    public required V1alpha1SecurityCenterBigQueryExportSpecOrganizationRef OrganizationRef { get; set; }

    /// <summary>The SecurityCenterBigQueryExport name. If not given, the metadata.name will be used.</summary>
...
{
    /// <summary>Output only. The time at which the BigQuery export was created.</summary>
    [JsonPropertyName("createTime")]
    public string? CreateTime { get; set; }

    /// <summary>Output only. Email address of the user who last edited the BigQuery export.</summary>
    [JsonPropertyName("mostRecentEditor")]
    public string? MostRecentEditor { get; set; }

    /// <summary>Output only. The service account that needs permission to create table and upload data to the BigQuery dataset.</summary>
    [JsonPropertyName("principal")]
    public string? Principal { get; set; }

    /// <summary>Output only. The most recent time at which the BigQuery export was updated.</summary>
...
public partial class V1alpha1SecurityCenterBigQueryExportStatus
{
    ...
    public IList<V1alpha1SecurityCenterBigQueryExportStatusConditions>? Conditions { get; set; }

    /// <summary>A unique specifier for the SecurityCenterBigQueryExport resource in GCP.</summary>
    ...
    public V1alpha1SecurityCenterBigQueryExportStatusObservedState? ObservedState { get; set; }
}
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "SecurityCenterBigQueryExport";
    public const string KubeGroup = "securitycenter.cnrm.cloud.google.com";
    public const string KubePluralName = "securitycenterbigqueryexports";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "SecurityCenterBigQueryExport";
    ...
    public required V1alpha1SecurityCenterBigQueryExportSpec Spec { get; set; }

    /// <summary>SecurityCenterBigQueryExportStatus defines the config connector machine state of SecurityCenterBigQueryExport</summary>
    [JsonPropertyName("status")]
    public V1alpha1SecurityCenterBigQueryExportStatus? Status { get; set; }
}