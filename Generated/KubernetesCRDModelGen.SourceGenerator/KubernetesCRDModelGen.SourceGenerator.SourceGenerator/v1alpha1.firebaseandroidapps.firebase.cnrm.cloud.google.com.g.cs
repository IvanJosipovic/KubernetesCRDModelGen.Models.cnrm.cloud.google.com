...
public partial class V1alpha1FirebaseAndroidAppList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1FirebaseAndroidApp>
{
    ...
    public string Kind { get; set; } = "FirebaseAndroidAppList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1FirebaseAndroidApp objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1FirebaseAndroidApp> Items { get; set; }
}
...
public partial class V1alpha1FirebaseAndroidAppSpec
{
    ...
    public required V1alpha1FirebaseAndroidAppSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1FirebaseAndroidApp : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1FirebaseAndroidAppSpec>, IStatus<V1alpha1FirebaseAndroidAppStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "FirebaseAndroidApp";
    ...
    public required V1alpha1FirebaseAndroidAppSpec Spec { get; set; }
