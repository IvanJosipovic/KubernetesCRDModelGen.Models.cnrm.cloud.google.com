...
public partial class V1beta1CloudFunctionsFunctionList : IKubernetesObject<V1ListMeta>, IItems<V1beta1CloudFunctionsFunction>
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "CloudFunctionsFunctionList";
    ...
    public string ApiVersion { get; set; } = "cloudfunctions.cnrm.cloud.google.com/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "CloudFunctionsFunctionList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1CloudFunctionsFunction objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1CloudFunctionsFunction> Items { get; set; }
}
...
public partial class V1beta1CloudFunctionsFunctionSpecEventTrigger
{
    ...
    public required V1beta1CloudFunctionsFunctionSpecEventTriggerResourceRef ResourceRef { get; set; }
...
public partial class V1beta1CloudFunctionsFunctionSpec
{
    ...
    public required V1beta1CloudFunctionsFunctionSpecProjectRef ProjectRef { get; set; }
...
public partial class V1beta1CloudFunctionsFunction : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1CloudFunctionsFunctionSpec>, IStatus<V1beta1CloudFunctionsFunctionStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "CloudFunctionsFunction";
    ...
    public required V1beta1CloudFunctionsFunctionSpec Spec { get; set; }
