...
public partial class V1alpha1ComputeNetworkEdgeSecurityServiceList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ComputeNetworkEdgeSecurityService>
{
    ...
    public string Kind { get; set; } = "ComputeNetworkEdgeSecurityServiceList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1ComputeNetworkEdgeSecurityService objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1ComputeNetworkEdgeSecurityService> Items { get; set; }
}
...
public partial class V1alpha1ComputeNetworkEdgeSecurityServiceSpec
{
    ...
    public required V1alpha1ComputeNetworkEdgeSecurityServiceSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1ComputeNetworkEdgeSecurityService : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1ComputeNetworkEdgeSecurityServiceSpec>, IStatus<V1alpha1ComputeNetworkEdgeSecurityServiceStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ComputeNetworkEdgeSecurityService";
    ...
    public required V1alpha1ComputeNetworkEdgeSecurityServiceSpec Spec { get; set; }
