...
public partial class V1beta1ApigeeEnvironmentList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ApigeeEnvironment>
{
    ...
    public string Kind { get; set; } = "ApigeeEnvironmentList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ApigeeEnvironment objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ApigeeEnvironment> Items { get; set; }
}
...
public partial class V1beta1ApigeeEnvironmentSpec
{
    ...
    public required V1beta1ApigeeEnvironmentSpecApigeeOrganizationRef ApigeeOrganizationRef { get; set; }
...
public partial class V1beta1ApigeeEnvironment : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ApigeeEnvironmentSpec>, IStatus<V1beta1ApigeeEnvironmentStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ApigeeEnvironment";
    ...
    public required V1beta1ApigeeEnvironmentSpec Spec { get; set; }
