...
public partial class V1beta1BigQueryDataTransferConfigList : IKubernetesObject<V1ListMeta>, IItems<V1beta1BigQueryDataTransferConfig>
{
    ...
    public string ApiVersion { get; set; } = "bigquerydatatransfer.cnrm.cloud.google.com/v1beta1";
    ...
    /// <summary>List of V1beta1BigQueryDataTransferConfig objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1BigQueryDataTransferConfig> Items { get; set; }
}
...
public partial class V1beta1BigQueryDataTransferConfigSpec
{
    ...
    public required V1beta1BigQueryDataTransferConfigSpecProjectRef ProjectRef { get; set; }
...
public partial class V1beta1BigQueryDataTransferConfig : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1BigQueryDataTransferConfigSpec>, IStatus<V1beta1BigQueryDataTransferConfigStatus?>
{
    ...
    public required V1beta1BigQueryDataTransferConfigSpec Spec { get; set; }
