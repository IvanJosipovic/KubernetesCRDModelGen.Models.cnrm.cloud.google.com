...
public partial class V1beta1PrivilegedAccessManagerEntitlementList : IKubernetesObject<V1ListMeta>, IItems<V1beta1PrivilegedAccessManagerEntitlement>
{
    ...
    public string ApiVersion { get; set; } = "privilegedaccessmanager.cnrm.cloud.google.com/v1beta1";
...
public partial class V1beta1PrivilegedAccessManagerEntitlementSpecApprovalWorkflow
{
    ...
    public required V1beta1PrivilegedAccessManagerEntitlementSpecApprovalWorkflowManualApprovals ManualApprovals { get; set; }
}
...
public partial class V1beta1PrivilegedAccessManagerEntitlementSpecPrivilegedAccessGcpIAMAccess
{
    ...
    public required IList<V1beta1PrivilegedAccessManagerEntitlementSpecPrivilegedAccessGcpIAMAccessRoleBindings> RoleBindings { get; set; }
}
...
public partial class V1beta1PrivilegedAccessManagerEntitlementSpecPrivilegedAccess
{
    ...
    public required V1beta1PrivilegedAccessManagerEntitlementSpecPrivilegedAccessGcpIAMAccess GcpIAMAccess { get; set; }
}
...
public partial class V1beta1PrivilegedAccessManagerEntitlementSpec
{
    ...
    public required IList<V1beta1PrivilegedAccessManagerEntitlementSpecEligibleUsers> EligibleUsers { get; set; }
    ...
    public required V1beta1PrivilegedAccessManagerEntitlementSpecPrivilegedAccess PrivilegedAccess { get; set; }
    ...
    public required V1beta1PrivilegedAccessManagerEntitlementSpecRequesterJustificationConfig RequesterJustificationConfig { get; set; }
