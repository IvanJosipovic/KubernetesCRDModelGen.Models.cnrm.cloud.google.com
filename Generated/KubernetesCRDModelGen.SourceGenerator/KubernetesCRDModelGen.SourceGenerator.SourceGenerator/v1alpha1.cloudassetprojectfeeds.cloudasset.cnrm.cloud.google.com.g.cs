...
public partial class V1alpha1CloudAssetProjectFeedList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1CloudAssetProjectFeed>
{
    ...
    public string Kind { get; set; } = "CloudAssetProjectFeedList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1CloudAssetProjectFeed objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1CloudAssetProjectFeed> Items { get; set; }
}
...
public partial class V1alpha1CloudAssetProjectFeedSpecFeedOutputConfig
{
    ...
    public required V1alpha1CloudAssetProjectFeedSpecFeedOutputConfigPubsubDestination PubsubDestination { get; set; }
}
...
public partial class V1alpha1CloudAssetProjectFeedSpec
{
    ...
    public required V1alpha1CloudAssetProjectFeedSpecFeedOutputConfig FeedOutputConfig { get; set; }

    /// <summary>The project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public required V1alpha1CloudAssetProjectFeedSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1CloudAssetProjectFeed : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1CloudAssetProjectFeedSpec>, IStatus<V1alpha1CloudAssetProjectFeedStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "CloudAssetProjectFeed";
    ...
    public required V1alpha1CloudAssetProjectFeedSpec Spec { get; set; }
