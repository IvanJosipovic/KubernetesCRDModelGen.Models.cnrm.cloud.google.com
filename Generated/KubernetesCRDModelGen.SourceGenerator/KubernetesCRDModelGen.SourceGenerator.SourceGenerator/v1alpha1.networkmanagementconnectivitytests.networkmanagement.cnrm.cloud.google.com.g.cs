...
public partial class V1alpha1NetworkManagementConnectivityTestList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1NetworkManagementConnectivityTest>
{
    ...
    public string ApiVersion { get; set; } = "networkmanagement.cnrm.cloud.google.com/v1alpha1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "NetworkManagementConnectivityTestList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1NetworkManagementConnectivityTest objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1NetworkManagementConnectivityTest> Items { get; set; }
}
...
public partial class V1alpha1NetworkManagementConnectivityTestSpec
{
    ...
    public required V1alpha1NetworkManagementConnectivityTestSpecDestination Destination { get; set; }
    ...
    /// <summary>Immutable. The Project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public required V1alpha1NetworkManagementConnectivityTestSpecProjectRef ProjectRef { get; set; }
    ...
    public required V1alpha1NetworkManagementConnectivityTestSpecSource Source { get; set; }
}
...
public partial class V1alpha1NetworkManagementConnectivityTest : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1NetworkManagementConnectivityTestSpec>, IStatus<V1alpha1NetworkManagementConnectivityTestStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "NetworkManagementConnectivityTest";
    ...
    public required V1alpha1NetworkManagementConnectivityTestSpec Spec { get; set; }
