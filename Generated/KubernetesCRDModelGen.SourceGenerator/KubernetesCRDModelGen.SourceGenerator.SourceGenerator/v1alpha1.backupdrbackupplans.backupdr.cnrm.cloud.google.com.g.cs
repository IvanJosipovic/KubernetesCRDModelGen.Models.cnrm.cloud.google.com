...
public partial class V1alpha1BackupDRBackupPlanList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1BackupDRBackupPlan>
{
    ...
    /// <summary>List of V1alpha1BackupDRBackupPlan objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1BackupDRBackupPlan> Items { get; set; }
}
...
public partial class V1alpha1BackupDRBackupPlanSpec
{
    ...
    public required V1alpha1BackupDRBackupPlanSpecBackupVaultRef BackupVaultRef { get; set; }
    ...
    public required V1alpha1BackupDRBackupPlanSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1BackupDRBackupPlan : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1BackupDRBackupPlanSpec>, IStatus<V1alpha1BackupDRBackupPlanStatus?>
{
    ...
    public required V1alpha1BackupDRBackupPlanSpec Spec { get; set; }
