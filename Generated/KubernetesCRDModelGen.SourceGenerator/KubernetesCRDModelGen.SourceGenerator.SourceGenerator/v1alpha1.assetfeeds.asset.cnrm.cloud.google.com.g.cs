...
public partial class V1alpha1AssetFeedList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1AssetFeed>
{
    ...
    public string ApiVersion { get; set; } = "asset.cnrm.cloud.google.com/v1alpha1";
    ...
    /// <summary>List of V1alpha1AssetFeed objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1AssetFeed> Items { get; set; }
}
...
public partial class V1alpha1AssetFeedSpec
{
    ...
    public required V1alpha1AssetFeedSpecFeedOutputConfig FeedOutputConfig { get; set; }
...
public partial class V1alpha1AssetFeed : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1AssetFeedSpec>, IStatus<V1alpha1AssetFeedStatus?>
{
    ...
    public required V1alpha1AssetFeedSpec Spec { get; set; }
