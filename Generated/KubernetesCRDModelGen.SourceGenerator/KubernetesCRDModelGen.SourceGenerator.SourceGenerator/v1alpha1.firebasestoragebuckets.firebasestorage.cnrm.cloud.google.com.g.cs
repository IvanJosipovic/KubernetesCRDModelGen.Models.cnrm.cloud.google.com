...
public partial class V1alpha1FirebaseStorageBucketList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1FirebaseStorageBucket>
{
    ...
    public string ApiVersion { get; set; } = "firebasestorage.cnrm.cloud.google.com/v1alpha1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "FirebaseStorageBucketList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1FirebaseStorageBucket objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1FirebaseStorageBucket> Items { get; set; }
}
...
public partial class V1alpha1FirebaseStorageBucketSpec
{
    ...
    public required V1alpha1FirebaseStorageBucketSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1FirebaseStorageBucket : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1FirebaseStorageBucketSpec>, IStatus<V1alpha1FirebaseStorageBucketStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "FirebaseStorageBucket";
    ...
    public required V1alpha1FirebaseStorageBucketSpec Spec { get; set; }
