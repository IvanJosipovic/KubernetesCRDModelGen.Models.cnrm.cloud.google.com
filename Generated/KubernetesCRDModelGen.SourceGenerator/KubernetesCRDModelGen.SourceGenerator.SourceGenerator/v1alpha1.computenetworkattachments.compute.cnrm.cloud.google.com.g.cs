...
public partial class V1alpha1ComputeNetworkAttachmentList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ComputeNetworkAttachment>
{
    ...
    public string Kind { get; set; } = "ComputeNetworkAttachmentList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1ComputeNetworkAttachment objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1ComputeNetworkAttachment> Items { get; set; }
}
...
public partial class V1alpha1ComputeNetworkAttachmentSpec
{
    ...
    public required V1alpha1ComputeNetworkAttachmentSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1ComputeNetworkAttachment : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1ComputeNetworkAttachmentSpec>, IStatus<V1alpha1ComputeNetworkAttachmentStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ComputeNetworkAttachment";
    ...
    public required V1alpha1ComputeNetworkAttachmentSpec Spec { get; set; }
