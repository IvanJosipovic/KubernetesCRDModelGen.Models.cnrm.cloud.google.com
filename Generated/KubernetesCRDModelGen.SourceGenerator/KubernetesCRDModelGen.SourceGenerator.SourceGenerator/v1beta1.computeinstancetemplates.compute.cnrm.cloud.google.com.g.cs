...
public partial class V1beta1ComputeInstanceTemplateList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ComputeInstanceTemplate>
{
    ...
    public string Kind { get; set; } = "ComputeInstanceTemplateList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ComputeInstanceTemplate objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ComputeInstanceTemplate> Items { get; set; }
}
...
public partial class V1beta1ComputeInstanceTemplateSpecDiskSourceImageEncryptionKey
{
    ...
    public required V1beta1ComputeInstanceTemplateSpecDiskSourceImageEncryptionKeyKmsKeySelfLinkRef KmsKeySelfLinkRef { get; set; }
...
public partial class V1beta1ComputeInstanceTemplateSpecDiskSourceSnapshotEncryptionKey
{
    ...
    /// </summary>
    [JsonPropertyName("kmsKeySelfLinkRef")]
    public required V1beta1ComputeInstanceTemplateSpecDiskSourceSnapshotEncryptionKeyKmsKeySelfLinkRef KmsKeySelfLinkRef { get; set; }
...
public partial class V1beta1ComputeInstanceTemplateSpecNetworkPerformanceConfig
{
    ...
    public required string TotalEgressBandwidthTier { get; set; }
}
...
public partial class V1beta1ComputeInstanceTemplateSpec
{
    ...
    public required IList<V1beta1ComputeInstanceTemplateSpecDisk> Disk { get; set; }
...
public partial class V1beta1ComputeInstanceTemplate : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ComputeInstanceTemplateSpec>, IStatus<V1beta1ComputeInstanceTemplateStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ComputeInstanceTemplate";
    ...
    public required V1beta1ComputeInstanceTemplateSpec Spec { get; set; }
