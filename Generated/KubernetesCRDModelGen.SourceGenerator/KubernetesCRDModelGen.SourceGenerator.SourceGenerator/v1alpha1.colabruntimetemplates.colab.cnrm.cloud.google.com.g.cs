...
public partial class V1alpha1ColabRuntimeTemplateList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ColabRuntimeTemplate>
{
    ...
    public string ApiVersion { get; set; } = "colab.cnrm.cloud.google.com/v1alpha1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ColabRuntimeTemplateList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1ColabRuntimeTemplate objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1ColabRuntimeTemplate> Items { get; set; }
}
...
public partial class V1alpha1ColabRuntimeTemplateSpecNetworkSpec
{
    ...
    public required V1alpha1ColabRuntimeTemplateSpecNetworkSpecSubnetworkRef SubnetworkRef { get; set; }
}
...
public partial class V1alpha1ColabRuntimeTemplateSpec
{
    ...
    public required V1alpha1ColabRuntimeTemplateSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1ColabRuntimeTemplate : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1ColabRuntimeTemplateSpec>, IStatus<V1alpha1ColabRuntimeTemplateStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ColabRuntimeTemplate";
    ...
    public required V1alpha1ColabRuntimeTemplateSpec Spec { get; set; }
