...
public partial class V1alpha1DiscoveryEngineDataStoreList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1DiscoveryEngineDataStore>
{
    ...
    public const string KubeKind = "DiscoveryEngineDataStoreList";
    ...
    public string Kind { get; set; } = "DiscoveryEngineDataStoreList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1DiscoveryEngineDataStore objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1DiscoveryEngineDataStore> Items { get; set; }
}
...
public partial class V1alpha1DiscoveryEngineDataStoreSpec
{
    ...
    public required V1alpha1DiscoveryEngineDataStoreSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1DiscoveryEngineDataStore : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1DiscoveryEngineDataStoreSpec>, IStatus<V1alpha1DiscoveryEngineDataStoreStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DiscoveryEngineDataStore";
    ...
    public required V1alpha1DiscoveryEngineDataStoreSpec Spec { get; set; }
