...
public partial class V1beta1IAPSettingsSpecAppEngineRef
{
    ...
    public required V1beta1IAPSettingsSpecAppEngineRefApplicationRef ApplicationRef { get; set; }

    /// <summary>The Project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public required V1beta1IAPSettingsSpecAppEngineRefProjectRef ProjectRef { get; set; }
...
public partial class V1beta1IAPSettingsSpecComputeServiceRef
{
    /// <summary>The Project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public required V1beta1IAPSettingsSpecComputeServiceRefProjectRef ProjectRef { get; set; }
...
public partial class V1beta1IAPSettingsSpecProjectWebRef
{
    /// <summary>The Project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public required V1beta1IAPSettingsSpecProjectWebRefProjectRef ProjectRef { get; set; }
}
...
public partial class V1beta1IAPSettings : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1IAPSettingsSpec>, IStatus<V1beta1IAPSettingsStatus?>
{
    ...
    public required V1beta1IAPSettingsSpec Spec { get; set; }
