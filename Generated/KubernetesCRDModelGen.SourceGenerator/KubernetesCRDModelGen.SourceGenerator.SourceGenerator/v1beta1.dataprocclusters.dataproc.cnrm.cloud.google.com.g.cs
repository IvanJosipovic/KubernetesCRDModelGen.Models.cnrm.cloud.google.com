...
public partial class V1beta1DataprocClusterList : IKubernetesObject<V1ListMeta>, IItems<V1beta1DataprocCluster>
{
    ...
    public string Kind { get; set; } = "DataprocClusterList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1DataprocCluster objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1DataprocCluster> Items { get; set; }
}
...
public partial class V1beta1DataprocClusterSpecConfigDataprocMetricConfigMetrics
{
    ...
    public required string MetricSource { get; set; }
}
...
public partial class V1beta1DataprocClusterSpecConfigDataprocMetricConfig
{
    ...
    public required IList<V1beta1DataprocClusterSpecConfigDataprocMetricConfigMetrics> Metrics { get; set; }
}
...
public partial class V1beta1DataprocClusterSpecConfigGceClusterConfigNodeGroupAffinity
{
    ...
    public required V1beta1DataprocClusterSpecConfigGceClusterConfigNodeGroupAffinityNodeGroupRef NodeGroupRef { get; set; }
}
...
public partial class V1beta1DataprocClusterSpecConfigMetastoreConfig
{
    ...
    public required V1beta1DataprocClusterSpecConfigMetastoreConfigDataprocMetastoreServiceRef DataprocMetastoreServiceRef { get; set; }
}
...
public partial class V1beta1DataprocClusterSpecVirtualClusterConfigAuxiliaryServicesConfigMetastoreConfig
{
    /// <summary>Immutable.</summary>
    [JsonPropertyName("dataprocMetastoreServiceRef")]
    public required V1beta1DataprocClusterSpecVirtualClusterConfigAuxiliaryServicesConfigMetastoreConfigDataprocMetastoreServiceRef DataprocMetastoreServiceRef { get; set; }
}
...
public partial class V1beta1DataprocClusterSpecVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTarget
{
    ...
    public required V1beta1DataprocClusterSpecVirtualClusterConfigKubernetesClusterConfigGkeClusterConfigNodePoolTargetNodePoolRef NodePoolRef { get; set; }
...
public partial class V1beta1DataprocClusterSpecVirtualClusterConfigKubernetesClusterConfig
{
    ...
    public required V1beta1DataprocClusterSpecVirtualClusterConfigKubernetesClusterConfigGkeClusterConfig GkeClusterConfig { get; set; }
...
public partial class V1beta1DataprocClusterSpecVirtualClusterConfig
{
    ...
    public required V1beta1DataprocClusterSpecVirtualClusterConfigKubernetesClusterConfig KubernetesClusterConfig { get; set; }
...
public partial class V1beta1DataprocCluster : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1DataprocClusterSpec>, IStatus<V1beta1DataprocClusterStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DataprocCluster";
    ...
    public required V1beta1DataprocClusterSpec Spec { get; set; }
