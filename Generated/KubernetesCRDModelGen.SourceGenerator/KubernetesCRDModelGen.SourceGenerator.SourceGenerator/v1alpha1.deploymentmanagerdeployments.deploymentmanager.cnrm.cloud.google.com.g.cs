...
public partial class V1alpha1DeploymentManagerDeploymentList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1DeploymentManagerDeployment>
{
    ...
    public string ApiVersion { get; set; } = "deploymentmanager.cnrm.cloud.google.com/v1alpha1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DeploymentManagerDeploymentList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1DeploymentManagerDeployment objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1DeploymentManagerDeployment> Items { get; set; }
}
...
public partial class V1alpha1DeploymentManagerDeploymentSpecTarget
{
    ...
    public required V1alpha1DeploymentManagerDeploymentSpecTargetConfig Config { get; set; }
...
public partial class V1alpha1DeploymentManagerDeploymentSpec
{
    ...
    public required V1alpha1DeploymentManagerDeploymentSpecProjectRef ProjectRef { get; set; }
    ...
    public required V1alpha1DeploymentManagerDeploymentSpecTarget Target { get; set; }
}
...
public partial class V1alpha1DeploymentManagerDeployment : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1DeploymentManagerDeploymentSpec>, IStatus<V1alpha1DeploymentManagerDeploymentStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DeploymentManagerDeployment";
    ...
    public required V1alpha1DeploymentManagerDeploymentSpec Spec { get; set; }
