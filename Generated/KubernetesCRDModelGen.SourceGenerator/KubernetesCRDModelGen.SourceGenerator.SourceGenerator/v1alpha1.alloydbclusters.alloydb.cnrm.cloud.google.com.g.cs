...
public partial class V1alpha1AlloyDBClusterList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1AlloyDBCluster>
{
    ...
    /// <summary>List of V1alpha1AlloyDBCluster objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1AlloyDBCluster> Items { get; set; }
}
...
public partial class V1alpha1AlloyDBClusterSpecAutomatedBackupPolicyWeeklySchedule
{
    ...
    public required IList<V1alpha1AlloyDBClusterSpecAutomatedBackupPolicyWeeklyScheduleStartTimes> StartTimes { get; set; }
}
...
public partial class V1alpha1AlloyDBClusterSpecInitialUser
{
    ...
    public required V1alpha1AlloyDBClusterSpecInitialUserPassword Password { get; set; }
...
public partial class V1alpha1AlloyDBClusterSpecMaintenanceUpdatePolicyMaintenanceWindows
{
    ...
    public required V1alpha1AlloyDBClusterSpecMaintenanceUpdatePolicyMaintenanceWindowsStartTime StartTime { get; set; }
}
...
public partial class V1alpha1AlloyDBClusterSpecRestoreBackupSource
{
    ...
    public required V1alpha1AlloyDBClusterSpecRestoreBackupSourceBackupNameRef BackupNameRef { get; set; }
}
...
public partial class V1alpha1AlloyDBClusterSpecRestoreContinuousBackupSource
{
    ...
    public required V1alpha1AlloyDBClusterSpecRestoreContinuousBackupSourceClusterRef ClusterRef { get; set; }
...
public partial class V1alpha1AlloyDBClusterSpecSecondaryConfig
{
    ...
    public required V1alpha1AlloyDBClusterSpecSecondaryConfigPrimaryClusterNameRef PrimaryClusterNameRef { get; set; }
}
...
public partial class V1alpha1AlloyDBClusterSpec
{
    ...
    public required V1alpha1AlloyDBClusterSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1AlloyDBCluster : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1AlloyDBClusterSpec>, IStatus<V1alpha1AlloyDBClusterStatus?>
{
    ...
    public required V1alpha1AlloyDBClusterSpec Spec { get; set; }
