...
public partial class V1alpha1DocumentAIProcessorList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1DocumentAIProcessor>
{
    ...
    public string ApiVersion { get; set; } = "documentai.cnrm.cloud.google.com/v1alpha1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DocumentAIProcessorList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1DocumentAIProcessor objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1DocumentAIProcessor> Items { get; set; }
}
...
public partial class V1alpha1DocumentAIProcessorSpec
{
    ...
    public required V1alpha1DocumentAIProcessorSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1DocumentAIProcessor : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1DocumentAIProcessorSpec>, IStatus<V1alpha1DocumentAIProcessorStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DocumentAIProcessor";
    ...
    public required V1alpha1DocumentAIProcessorSpec Spec { get; set; }
