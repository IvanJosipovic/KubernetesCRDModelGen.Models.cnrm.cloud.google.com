...
public partial class V1alpha1DataplexZoneList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1DataplexZone>
{
    ...
    public string Kind { get; set; } = "DataplexZoneList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1DataplexZone objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1DataplexZone> Items { get; set; }
}
...
public partial class V1alpha1DataplexZoneSpec
{
    ...
    public required V1alpha1DataplexZoneSpecLakeRef LakeRef { get; set; }
    ...
    public required V1alpha1DataplexZoneSpecResourceSpec ResourceSpec { get; set; }
...
public partial class V1alpha1DataplexZone : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1DataplexZoneSpec>, IStatus<V1alpha1DataplexZoneStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DataplexZone";
    ...
    public required V1alpha1DataplexZoneSpec Spec { get; set; }
