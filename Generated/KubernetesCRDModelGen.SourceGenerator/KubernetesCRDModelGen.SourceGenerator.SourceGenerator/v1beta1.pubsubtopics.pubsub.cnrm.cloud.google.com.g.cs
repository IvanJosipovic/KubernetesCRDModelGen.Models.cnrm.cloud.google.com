...
public partial class V1beta1PubSubTopicList : IKubernetesObject<V1ListMeta>, IItems<V1beta1PubSubTopic>
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "PubSubTopicList";
    ...
    public string Kind { get; set; } = "PubSubTopicList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1PubSubTopic objects.</summary>
...
public partial class V1beta1PubSubTopicSpecMessageStoragePolicy
{
    ...
    /// <summary>Optional. If true, `allowed_persistence_regions` is also used to enforce in-transit guarantees for messages. That is, Pub/Sub will fail Publish operations on this topic and subscribe operations on any subscription attached to this topic in any region that is not in `allowed_persistence_regions`.</summary>
...
public partial class V1beta1PubSubTopic : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1PubSubTopicSpec?>, IStatus<V1beta1PubSubTopicStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "PubSubTopic";
