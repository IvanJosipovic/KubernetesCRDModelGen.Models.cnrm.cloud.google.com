...
public partial class V1beta1ConfigControllerInstanceList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ConfigControllerInstance>
{
    ...
    public string ApiVersion { get; set; } = "configcontroller.cnrm.cloud.google.com/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ConfigControllerInstanceList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ConfigControllerInstance objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ConfigControllerInstance> Items { get; set; }
}
...
public partial class V1beta1ConfigControllerInstanceSpecManagementConfigStandardManagementConfig
{
    ...
    /// <summary>Immutable. The /28 network that the masters will use.</summary>
    [JsonPropertyName("masterIPv4CidrBlock")]
    public required string MasterIPv4CidrBlock { get; set; }
...
public partial class V1beta1ConfigControllerInstanceSpec
{
    ...
    public required V1beta1ConfigControllerInstanceSpecManagementConfig ManagementConfig { get; set; }

    /// <summary>Immutable. The Project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public required V1beta1ConfigControllerInstanceSpecProjectRef ProjectRef { get; set; }
...
public partial class V1beta1ConfigControllerInstance : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ConfigControllerInstanceSpec>, IStatus<V1beta1ConfigControllerInstanceStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ConfigControllerInstance";
    ...
    public required V1beta1ConfigControllerInstanceSpec Spec { get; set; }
