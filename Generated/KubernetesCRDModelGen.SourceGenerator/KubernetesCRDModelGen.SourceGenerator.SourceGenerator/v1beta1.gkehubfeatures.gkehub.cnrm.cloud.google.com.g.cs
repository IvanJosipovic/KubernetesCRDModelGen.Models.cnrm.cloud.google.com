...
public partial class V1beta1GKEHubFeatureList : IKubernetesObject<V1ListMeta>, IItems<V1beta1GKEHubFeature>
{
    ...
    public string Kind { get; set; } = "GKEHubFeatureList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1GKEHubFeature objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1GKEHubFeature> Items { get; set; }
}
...
public partial class V1beta1GKEHubFeatureSpecSpecMulticlusteringress
{
    ...
    public required V1beta1GKEHubFeatureSpecSpecMulticlusteringressConfigMembershipRef ConfigMembershipRef { get; set; }
}
...
public partial class V1beta1GKEHubFeatureSpec
{
    ...
    public required V1beta1GKEHubFeatureSpecProjectRef ProjectRef { get; set; }
...
public partial class V1beta1GKEHubFeature : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1GKEHubFeatureSpec>, IStatus<V1beta1GKEHubFeatureStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "GKEHubFeature";
    ...
    [JsonPropertyName("spec")]
    public required V1beta1GKEHubFeatureSpec Spec { get; set; }
