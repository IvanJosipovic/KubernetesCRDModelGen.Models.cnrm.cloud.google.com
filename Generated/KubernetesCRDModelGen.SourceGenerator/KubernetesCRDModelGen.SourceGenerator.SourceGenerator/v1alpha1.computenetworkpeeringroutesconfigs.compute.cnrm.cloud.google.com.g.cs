...
public partial class V1alpha1ComputeNetworkPeeringRoutesConfigList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ComputeNetworkPeeringRoutesConfig>
{
    ...
    public string Kind { get; set; } = "ComputeNetworkPeeringRoutesConfigList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1ComputeNetworkPeeringRoutesConfig objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1ComputeNetworkPeeringRoutesConfig> Items { get; set; }
}
...
public partial class V1alpha1ComputeNetworkPeeringRoutesConfigSpec
{
    ...
    public required bool ExportCustomRoutes { get; set; }

    /// <summary>Whether to import the custom routes to the peer network.</summary>
    [JsonPropertyName("importCustomRoutes")]
    public required bool ImportCustomRoutes { get; set; }

    [JsonPropertyName("networkRef")]
    public required V1alpha1ComputeNetworkPeeringRoutesConfigSpecNetworkRef NetworkRef { get; set; }

    /// <summary>The project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public required V1alpha1ComputeNetworkPeeringRoutesConfigSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1ComputeNetworkPeeringRoutesConfig : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1ComputeNetworkPeeringRoutesConfigSpec>, IStatus<V1alpha1ComputeNetworkPeeringRoutesConfigStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ComputeNetworkPeeringRoutesConfig";
    ...
    public required V1alpha1ComputeNetworkPeeringRoutesConfigSpec Spec { get; set; }
