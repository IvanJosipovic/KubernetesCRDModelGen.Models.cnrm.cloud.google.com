...
public partial class V1alpha1VertexAIFeaturestoreList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1VertexAIFeaturestore>
{
    ...
    public string Kind { get; set; } = "VertexAIFeaturestoreList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1VertexAIFeaturestore objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1VertexAIFeaturestore> Items { get; set; }
}
...
public partial class V1alpha1VertexAIFeaturestoreSpecEncryptionSpec
{
    ...
    public required V1alpha1VertexAIFeaturestoreSpecEncryptionSpecKmsKeyRef KmsKeyRef { get; set; }
}
...
public partial class V1alpha1VertexAIFeaturestoreSpec
{
    ...
    public required V1alpha1VertexAIFeaturestoreSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1VertexAIFeaturestore : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1VertexAIFeaturestoreSpec>, IStatus<V1alpha1VertexAIFeaturestoreStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "VertexAIFeaturestore";
    ...
    public required V1alpha1VertexAIFeaturestoreSpec Spec { get; set; }
