...
public partial class V1alpha1TasksQueueList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1TasksQueue>
{
    ...
    public string ApiVersion { get; set; } = "cloudtasks.cnrm.cloud.google.com/v1alpha1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "TasksQueueList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1TasksQueue objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1TasksQueue> Items { get; set; }
}
...
{
    /// <summary>Specifies the fraction of operations to write to [Stackdriver Logging](https://cloud.google.com/logging/docs/). This field may contain any value between 0.0 and 1.0, inclusive. 0.0 is the default and means that no operations are logged.</summary>
...
public partial class V1alpha1TasksQueueSpec
{
    ...
    public V1alpha1TasksQueueSpecAppEngineRoutingOverride? AppEngineRoutingOverride { get; set; }

    /// <summary>Required. The location of the queue.</summary>
    [JsonPropertyName("location")]
    public string? Location { get; set; }

    /// <summary>Required. The host project of the queue.</summary>
    [JsonPropertyName("projectRef")]
    public V1alpha1TasksQueueSpecProjectRef? ProjectRef { get; set; }
    ...
    public V1alpha1TasksQueueSpecRateLimits? RateLimits { get; set; }

    /// <summary>The TasksQueue name. If not given, the metadata.name will be used.</summary>
    ...
    public V1alpha1TasksQueueSpecRetryConfig? RetryConfig { get; set; }
...
public partial class V1alpha1TasksQueueStatus
{
    ...
    public IList<V1alpha1TasksQueueStatusConditions>? Conditions { get; set; }

    /// <summary>A unique specifier for the TasksQueue resource in GCP.</summary>
...
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
[KubernetesEntity(Group = KubeGroup, Kind = KubeKind, ApiVersion = KubeApiVersion, PluralName = KubePluralName)]
public partial class V1alpha1TasksQueue : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1TasksQueueSpec>, IStatus<V1alpha1TasksQueueStatus?>
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "TasksQueue";
    public const string KubeGroup = "cloudtasks.cnrm.cloud.google.com";
    public const string KubePluralName = "tasksqueues";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "TasksQueue";
    ...
    public required V1alpha1TasksQueueSpec Spec { get; set; }
