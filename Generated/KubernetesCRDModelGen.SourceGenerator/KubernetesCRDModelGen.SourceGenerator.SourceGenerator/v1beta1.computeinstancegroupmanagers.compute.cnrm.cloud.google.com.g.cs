...
/// <summary>ComputeInstanceGroupManager is the Schema for the ComputeInstanceGroupManager API</summary>
...
public partial class V1beta1ComputeInstanceGroupManagerList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ComputeInstanceGroupManager>
{
    ...
    public string Kind { get; set; } = "ComputeInstanceGroupManagerList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ComputeInstanceGroupManager objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ComputeInstanceGroupManager> Items { get; set; }
}
...
/// <summary>ComputeInstanceGroupManagerSpec defines the desired state of ComputeInstanceGroupManager</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.6.0+0fbafdb9fc339df17b265ba23ecc4a7be2359877")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1beta1ComputeInstanceGroupManagerSpec
{
    ...
    public required V1beta1ComputeInstanceGroupManagerSpecProjectRef ProjectRef { get; set; }
    ...
    [JsonPropertyName("targetSize")]
    public required long TargetSize { get; set; }
...
{
    /// <summary>Conditions represent the latest available observations of the ComputeInstanceGroupManager&apos;s current state.</summary>
...
public partial class V1beta1ComputeInstanceGroupManager : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ComputeInstanceGroupManagerSpec>, IStatus<V1beta1ComputeInstanceGroupManagerStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ComputeInstanceGroupManager";
    ...
    public required V1beta1ComputeInstanceGroupManagerSpec Spec { get; set; }
