...
public partial class V1alpha1DataplexLakeList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1DataplexLake>
{
    ...
    public string Kind { get; set; } = "DataplexLakeList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1DataplexLake objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1DataplexLake> Items { get; set; }
}
...
public partial class V1alpha1DataplexLakeSpec
{
    ...
    public required V1alpha1DataplexLakeSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1DataplexLake : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1DataplexLakeSpec>, IStatus<V1alpha1DataplexLakeStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DataplexLake";
    ...
    public required V1alpha1DataplexLakeSpec Spec { get; set; }
