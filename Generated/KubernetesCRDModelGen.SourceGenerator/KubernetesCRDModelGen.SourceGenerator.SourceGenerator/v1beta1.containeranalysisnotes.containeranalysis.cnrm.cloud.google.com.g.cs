...
public partial class V1beta1ContainerAnalysisNoteList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ContainerAnalysisNote>
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "ContainerAnalysisNoteList";
    ...
    public string ApiVersion { get; set; } = "containeranalysis.cnrm.cloud.google.com/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ContainerAnalysisNoteList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ContainerAnalysisNote objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ContainerAnalysisNote> Items { get; set; }
}
...
public partial class V1beta1ContainerAnalysisNoteSpecBuild
{
    ...
    public required string BuilderVersion { get; set; }
}
...
public partial class V1beta1ContainerAnalysisNoteSpecDeployment
{
    ...
    public required IList<string> ResourceUri { get; set; }
}
...
public partial class V1beta1ContainerAnalysisNoteSpecDiscovery
{
    ...
    public required string AnalysisKind { get; set; }
}
...
public partial class V1beta1ContainerAnalysisNoteSpecImage
{
    ...
    public required V1beta1ContainerAnalysisNoteSpecImageFingerprint Fingerprint { get; set; }
...
public partial class V1beta1ContainerAnalysisNoteSpecPackageDistribution
{
    ...
    public required string CpeUri { get; set; }
...
public partial class V1beta1ContainerAnalysisNoteSpecVulnerabilityWindowsDetails
{
    ...
    public required IList<V1beta1ContainerAnalysisNoteSpecVulnerabilityWindowsDetailsFixingKbs> FixingKbs { get; set; }
...
public partial class V1beta1ContainerAnalysisNote : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ContainerAnalysisNoteSpec?>, IStatus<V1beta1ContainerAnalysisNoteStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ContainerAnalysisNote";
