...
public partial class V1beta1ManagedKafkaTopicList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ManagedKafkaTopic>
{
    ...
    /// <summary>List of V1beta1ManagedKafkaTopic objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ManagedKafkaTopic> Items { get; set; }
}
...
public partial class V1beta1ManagedKafkaTopicSpec
{
    ...
    public required V1beta1ManagedKafkaTopicSpecClusterRef ClusterRef { get; set; }
    ...
    public required V1beta1ManagedKafkaTopicSpecProjectRef ProjectRef { get; set; }
...
public partial class V1beta1ManagedKafkaTopic : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ManagedKafkaTopicSpec>, IStatus<V1beta1ManagedKafkaTopicStatus?>
{
    ...
    public required V1beta1ManagedKafkaTopicSpec Spec { get; set; }
