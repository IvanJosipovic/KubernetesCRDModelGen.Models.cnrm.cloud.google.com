...
public partial class V1alpha1AccessContextManagerGCPUserAccessBindingList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1AccessContextManagerGCPUserAccessBinding>
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "AccessContextManagerGCPUserAccessBindingList";
    ...
    public string Kind { get; set; } = "AccessContextManagerGCPUserAccessBindingList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1AccessContextManagerGCPUserAccessBinding objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1AccessContextManagerGCPUserAccessBinding> Items { get; set; }
}
...
public partial class V1alpha1AccessContextManagerGCPUserAccessBindingSpec
{
    ...
    public required IList<string> AccessLevels { get; set; }
    ...
    public required V1alpha1AccessContextManagerGCPUserAccessBindingSpecOrganizationRef OrganizationRef { get; set; }
...
public partial class V1alpha1AccessContextManagerGCPUserAccessBinding : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1AccessContextManagerGCPUserAccessBindingSpec>, IStatus<V1alpha1AccessContextManagerGCPUserAccessBindingStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "AccessContextManagerGCPUserAccessBinding";
    ...
    public required V1alpha1AccessContextManagerGCPUserAccessBindingSpec Spec { get; set; }
