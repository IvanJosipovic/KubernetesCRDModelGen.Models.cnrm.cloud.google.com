...
public partial class V1beta1ContainerAttachedClusterList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ContainerAttachedCluster>
{
    ...
    public string ApiVersion { get; set; } = "containerattached.cnrm.cloud.google.com/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ContainerAttachedClusterList";
...
public partial class V1beta1ContainerAttachedClusterSpecFleet
{
    ...
    public required V1beta1ContainerAttachedClusterSpecFleetProjectRef ProjectRef { get; set; }
}
...
public partial class V1beta1ContainerAttachedClusterSpec
{
    ...
    public required V1beta1ContainerAttachedClusterSpecFleet Fleet { get; set; }
    ...
    public required V1beta1ContainerAttachedClusterSpecOidcConfig OidcConfig { get; set; }
    ...
    /// <summary>The ID of the project in which the resource belongs.</summary>
    [JsonPropertyName("projectRef")]
    public required V1beta1ContainerAttachedClusterSpecProjectRef ProjectRef { get; set; }
...
public partial class V1beta1ContainerAttachedCluster : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ContainerAttachedClusterSpec>, IStatus<V1beta1ContainerAttachedClusterStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ContainerAttachedCluster";
    ...
    public required V1beta1ContainerAttachedClusterSpec Spec { get; set; }
