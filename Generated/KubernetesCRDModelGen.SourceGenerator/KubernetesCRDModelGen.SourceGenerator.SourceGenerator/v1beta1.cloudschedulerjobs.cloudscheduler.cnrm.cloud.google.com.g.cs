...
public partial class V1beta1CloudSchedulerJobList : IKubernetesObject<V1ListMeta>, IItems<V1beta1CloudSchedulerJob>
{
    public const string KubeApiVersion = "v1beta1";
    public const string KubeKind = "CloudSchedulerJobList";
    ...
    public string ApiVersion { get; set; } = "cloudscheduler.cnrm.cloud.google.com/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "CloudSchedulerJobList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1CloudSchedulerJob objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1CloudSchedulerJob> Items { get; set; }
}
...
public partial class V1beta1CloudSchedulerJobSpecPubsubTarget
{
    ...
    public required V1beta1CloudSchedulerJobSpecPubsubTargetTopicRef TopicRef { get; set; }
}
...
public partial class V1beta1CloudSchedulerJob : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1CloudSchedulerJobSpec>, IStatus<V1beta1CloudSchedulerJobStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "CloudSchedulerJob";
    ...
    public required V1beta1CloudSchedulerJobSpec Spec { get; set; }
