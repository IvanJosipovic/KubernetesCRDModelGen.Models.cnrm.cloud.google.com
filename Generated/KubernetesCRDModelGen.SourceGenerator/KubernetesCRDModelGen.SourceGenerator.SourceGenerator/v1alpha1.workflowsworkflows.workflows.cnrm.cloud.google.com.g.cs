...
public partial class V1alpha1WorkflowsWorkflowList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1WorkflowsWorkflow>
{
    ...
    public string ApiVersion { get; set; } = "workflows.cnrm.cloud.google.com/v1alpha1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "WorkflowsWorkflowList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1WorkflowsWorkflow objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1WorkflowsWorkflow> Items { get; set; }
}
...
public partial class V1alpha1WorkflowsWorkflowSpec
{
    ...
    public required V1alpha1WorkflowsWorkflowSpecProjectRef ProjectRef { get; set; }
    ...
    public required string SourceContents { get; set; }
...
public partial class V1alpha1WorkflowsWorkflow : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1WorkflowsWorkflowSpec>, IStatus<V1alpha1WorkflowsWorkflowStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "WorkflowsWorkflow";
    ...
    public required V1alpha1WorkflowsWorkflowSpec Spec { get; set; }
