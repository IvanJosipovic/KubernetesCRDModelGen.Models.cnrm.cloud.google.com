...
public partial class V1alpha1AppEngineFlexibleAppVersionList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1AppEngineFlexibleAppVersion>
{
    ...
    public const string KubeKind = "AppEngineFlexibleAppVersionList";
    ...
    public string Kind { get; set; } = "AppEngineFlexibleAppVersionList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1AppEngineFlexibleAppVersion objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1AppEngineFlexibleAppVersion> Items { get; set; }
}
...
public partial class V1alpha1AppEngineFlexibleAppVersionSpecAutomaticScalingCpuUtilization
{
    ...
    public required double TargetUtilization { get; set; }
}
...
public partial class V1alpha1AppEngineFlexibleAppVersionSpecAutomaticScaling
{
    ...
    public required V1alpha1AppEngineFlexibleAppVersionSpecAutomaticScalingCpuUtilization CpuUtilization { get; set; }
...
public partial class V1alpha1AppEngineFlexibleAppVersionSpecDeploymentCloudBuildOptions
{
    ...
    public required string AppYamlPath { get; set; }
...
public partial class V1alpha1AppEngineFlexibleAppVersionSpecResourcesVolumes
{
    ...
    public required string VolumeType { get; set; }
}
...
public partial class V1alpha1AppEngineFlexibleAppVersionSpec
{
    ...
    public required V1alpha1AppEngineFlexibleAppVersionSpecLivenessCheck LivenessCheck { get; set; }
    ...
    public required V1alpha1AppEngineFlexibleAppVersionSpecReadinessCheck ReadinessCheck { get; set; }
    ...
    public required V1alpha1AppEngineFlexibleAppVersionSpecServiceRef ServiceRef { get; set; }
...
public partial class V1alpha1AppEngineFlexibleAppVersion : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1AppEngineFlexibleAppVersionSpec>, IStatus<V1alpha1AppEngineFlexibleAppVersionStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "AppEngineFlexibleAppVersion";
    ...
    public required V1alpha1AppEngineFlexibleAppVersionSpec Spec { get; set; }
