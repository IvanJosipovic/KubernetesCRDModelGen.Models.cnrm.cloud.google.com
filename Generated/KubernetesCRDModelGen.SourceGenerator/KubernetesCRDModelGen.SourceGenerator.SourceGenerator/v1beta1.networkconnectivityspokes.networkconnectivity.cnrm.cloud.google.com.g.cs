...
public partial class V1beta1NetworkConnectivitySpokeList : IKubernetesObject<V1ListMeta>, IItems<V1beta1NetworkConnectivitySpoke>
{
    ...
    public string Kind { get; set; } = "NetworkConnectivitySpokeList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1NetworkConnectivitySpoke objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1NetworkConnectivitySpoke> Items { get; set; }
}
...
public partial class V1beta1NetworkConnectivitySpokeSpecLinkedInterconnectAttachments
{
    ...
    public required bool SiteToSiteDataTransfer { get; set; }

    /// <summary>Immutable.</summary>
    [JsonPropertyName("uris")]
    public required IList<V1beta1NetworkConnectivitySpokeSpecLinkedInterconnectAttachmentsUris> Uris { get; set; }
}
...
public partial class V1beta1NetworkConnectivitySpokeSpecLinkedRouterApplianceInstances
{
    ...
    public required IList<V1beta1NetworkConnectivitySpokeSpecLinkedRouterApplianceInstancesInstances> Instances { get; set; }
...
public partial class V1beta1NetworkConnectivitySpokeSpecLinkedVPCNetwork
{
    ...
    public required V1beta1NetworkConnectivitySpokeSpecLinkedVPCNetworkUriRef UriRef { get; set; }
}
...
public partial class V1beta1NetworkConnectivitySpokeSpecLinkedVpnTunnels
{
    ...
    /// <summary>Immutable.</summary>
    [JsonPropertyName("uris")]
    public required IList<V1beta1NetworkConnectivitySpokeSpecLinkedVpnTunnelsUris> Uris { get; set; }
}
...
public partial class V1beta1NetworkConnectivitySpokeSpec
{
    ...
    public required V1beta1NetworkConnectivitySpokeSpecHubRef HubRef { get; set; }
    ...
    public required V1beta1NetworkConnectivitySpokeSpecProjectRef ProjectRef { get; set; }
...
public partial class V1beta1NetworkConnectivitySpoke : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1NetworkConnectivitySpokeSpec>, IStatus<V1beta1NetworkConnectivitySpokeStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "NetworkConnectivitySpoke";
    ...
    public required V1beta1NetworkConnectivitySpokeSpec Spec { get; set; }
