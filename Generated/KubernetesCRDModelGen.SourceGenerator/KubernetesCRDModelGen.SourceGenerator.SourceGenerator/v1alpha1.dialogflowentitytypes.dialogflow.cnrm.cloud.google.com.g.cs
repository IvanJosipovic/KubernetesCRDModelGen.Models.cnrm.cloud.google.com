...
public partial class V1alpha1DialogflowEntityTypeList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1DialogflowEntityType>
{
    ...
    public string Kind { get; set; } = "DialogflowEntityTypeList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1DialogflowEntityType objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1DialogflowEntityType> Items { get; set; }
}
...
public partial class V1alpha1DialogflowEntityTypeSpecEntities
{
    ...
    public required IList<string> Synonyms { get; set; }
...
public partial class V1alpha1DialogflowEntityTypeSpec
{
    ...
    public required V1alpha1DialogflowEntityTypeSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1DialogflowEntityType : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1DialogflowEntityTypeSpec>, IStatus<V1alpha1DialogflowEntityTypeStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "DialogflowEntityType";
    ...
    public required V1alpha1DialogflowEntityTypeSpec Spec { get; set; }
