...
public partial class V1beta1CloudBuildWorkerPoolList : IKubernetesObject<V1ListMeta>, IItems<V1beta1CloudBuildWorkerPool>
{
    ...
    /// <summary>List of V1beta1CloudBuildWorkerPool objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1CloudBuildWorkerPool> Items { get; set; }
}
...
public partial class V1beta1CloudBuildWorkerPoolSpecPrivatePoolV1Config
{
    ...
    public required V1beta1CloudBuildWorkerPoolSpecPrivatePoolV1ConfigWorkerConfig WorkerConfig { get; set; }
}
...
public partial class V1beta1CloudBuildWorkerPoolSpec
{
    ...
    public required V1beta1CloudBuildWorkerPoolSpecPrivatePoolV1Config PrivatePoolV1Config { get; set; }

    /// <summary>The Project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public required V1beta1CloudBuildWorkerPoolSpecProjectRef ProjectRef { get; set; }
...
public partial class V1beta1CloudBuildWorkerPoolStatusObservedState
{
    ...
    /// <summary>Machine configuration for the workers in the pool.</summary>
    [JsonPropertyName("workerConfig")]
    public required V1beta1CloudBuildWorkerPoolStatusObservedStateWorkerConfig WorkerConfig { get; set; }
}
