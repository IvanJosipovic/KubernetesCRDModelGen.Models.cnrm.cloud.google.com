...
public partial class V1beta1NetworkSecurityServerTLSPolicyList : IKubernetesObject<V1ListMeta>, IItems<V1beta1NetworkSecurityServerTLSPolicy>
{
    ...
    public string Kind { get; set; } = "NetworkSecurityServerTLSPolicyList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1NetworkSecurityServerTLSPolicy objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1NetworkSecurityServerTLSPolicy> Items { get; set; }
}
...
public partial class V1beta1NetworkSecurityServerTLSPolicySpecMtlsPolicy
{
    ...
    public required IList<V1beta1NetworkSecurityServerTLSPolicySpecMtlsPolicyClientValidationCa> ClientValidationCa { get; set; }
}
...
public partial class V1beta1NetworkSecurityServerTLSPolicy : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1NetworkSecurityServerTLSPolicySpec>, IStatus<V1beta1NetworkSecurityServerTLSPolicyStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "NetworkSecurityServerTLSPolicy";
    ...
    public required V1beta1NetworkSecurityServerTLSPolicySpec Spec { get; set; }
