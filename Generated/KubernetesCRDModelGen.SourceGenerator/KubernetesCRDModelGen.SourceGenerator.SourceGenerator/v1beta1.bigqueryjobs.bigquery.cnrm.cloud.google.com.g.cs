...
public partial class V1beta1BigQueryJobList : IKubernetesObject<V1ListMeta>, IItems<V1beta1BigQueryJob>
{
    ...
    public string Kind { get; set; } = "BigQueryJobList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1BigQueryJob objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1BigQueryJob> Items { get; set; }
}
...
public partial class V1beta1BigQueryJobSpecCopyDestinationEncryptionConfiguration
{
    ...
    public required V1beta1BigQueryJobSpecCopyDestinationEncryptionConfigurationKmsKeyRef KmsKeyRef { get; set; }
...
public partial class V1beta1BigQueryJobSpecCopyDestinationTable
{
    ...
    public required V1beta1BigQueryJobSpecCopyDestinationTableTableRef TableRef { get; set; }
}
...
public partial class V1beta1BigQueryJobSpecCopySourceTables
{
    /// <summary>A reference to the table.</summary>
    [JsonPropertyName("tableRef")]
    public required V1beta1BigQueryJobSpecCopySourceTablesTableRef TableRef { get; set; }
}
...
public partial class V1beta1BigQueryJobSpecCopy
{
    ...
    public required IList<V1beta1BigQueryJobSpecCopySourceTables> SourceTables { get; set; }
...
public partial class V1beta1BigQueryJobSpecExtractSourceTable
{
    /// <summary>A reference to the table.</summary>
    [JsonPropertyName("tableRef")]
    public required V1beta1BigQueryJobSpecExtractSourceTableTableRef TableRef { get; set; }
}
...
public partial class V1beta1BigQueryJobSpecExtract
{
    ...
    public required IList<string> DestinationUris { get; set; }
...
public partial class V1beta1BigQueryJobSpecLoadDestinationEncryptionConfiguration
{
    ...
    /// </summary>
    [JsonPropertyName("kmsKeyRef")]
    public required V1beta1BigQueryJobSpecLoadDestinationEncryptionConfigurationKmsKeyRef KmsKeyRef { get; set; }
...
public partial class V1beta1BigQueryJobSpecLoadDestinationTable
{
    /// <summary>A reference to the table.</summary>
    [JsonPropertyName("tableRef")]
    public required V1beta1BigQueryJobSpecLoadDestinationTableTableRef TableRef { get; set; }
}
...
public partial class V1beta1BigQueryJobSpecLoad
{
    ...
    /// <summary>Immutable. The destination table to load the data into.</summary>
    [JsonPropertyName("destinationTable")]
    public required V1beta1BigQueryJobSpecLoadDestinationTable DestinationTable { get; set; }
    ...
    public required IList<string> SourceUris { get; set; }
...
public partial class V1beta1BigQueryJobSpecQueryDefaultDataset
{
    ...
    public required V1beta1BigQueryJobSpecQueryDefaultDatasetDatasetRef DatasetRef { get; set; }
}
...
public partial class V1beta1BigQueryJobSpecQueryDestinationEncryptionConfiguration
{
    ...
    /// </summary>
    [JsonPropertyName("kmsKeyRef")]
    public required V1beta1BigQueryJobSpecQueryDestinationEncryptionConfigurationKmsKeyRef KmsKeyRef { get; set; }
...
public partial class V1beta1BigQueryJobSpecQueryDestinationTable
{
    /// <summary>A reference to the table.</summary>
    [JsonPropertyName("tableRef")]
    public required V1beta1BigQueryJobSpecQueryDestinationTableTableRef TableRef { get; set; }
}
...
public partial class V1beta1BigQueryJob : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1BigQueryJobSpec?>, IStatus<V1beta1BigQueryJobStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "BigQueryJob";
