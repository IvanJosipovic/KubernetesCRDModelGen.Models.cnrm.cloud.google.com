...
public partial class V1alpha1AIPlatformModelList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1AIPlatformModel>
{
    ...
    public string Kind { get; set; } = "AIPlatformModelList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1AIPlatformModel objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1AIPlatformModel> Items { get; set; }
}
...
public partial class V1alpha1AIPlatformModelSpec
{
    ...
    public required V1alpha1AIPlatformModelSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1AIPlatformModel : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1AIPlatformModelSpec>, IStatus<V1alpha1AIPlatformModelStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "AIPlatformModel";
    ...
    public required V1alpha1AIPlatformModelSpec Spec { get; set; }
