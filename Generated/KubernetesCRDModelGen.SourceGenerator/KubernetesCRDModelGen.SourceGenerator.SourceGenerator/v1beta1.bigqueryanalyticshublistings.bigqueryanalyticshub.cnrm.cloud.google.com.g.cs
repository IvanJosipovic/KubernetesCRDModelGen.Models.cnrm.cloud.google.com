...
public partial class V1beta1BigQueryAnalyticsHubListingList : IKubernetesObject<V1ListMeta>, IItems<V1beta1BigQueryAnalyticsHubListing>
{
    ...
    public string ApiVersion { get; set; } = "bigqueryanalyticshub.cnrm.cloud.google.com/v1beta1";
    ...
    /// <summary>List of V1beta1BigQueryAnalyticsHubListing objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1BigQueryAnalyticsHubListing> Items { get; set; }
}
...
public partial class V1beta1BigQueryAnalyticsHubListingSpecSourceBigQueryDatasetSource
{
    ...
    public required V1beta1BigQueryAnalyticsHubListingSpecSourceBigQueryDatasetSourceDatasetRef DatasetRef { get; set; }
...
public partial class V1beta1BigQueryAnalyticsHubListingSpec
{
    ...
    public required V1beta1BigQueryAnalyticsHubListingSpecDataExchangeRef DataExchangeRef { get; set; }
    ...
    public required V1beta1BigQueryAnalyticsHubListingSpecProjectRef ProjectRef { get; set; }
