...
public partial class V1alpha1BigQueryReservationAssignmentList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1BigQueryReservationAssignment>
{
    ...
    /// <summary>List of V1alpha1BigQueryReservationAssignment objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1BigQueryReservationAssignment> Items { get; set; }
}
...
public partial class V1alpha1BigQueryReservationAssignmentSpec
{
    ...
    public required V1alpha1BigQueryReservationAssignmentSpecAssignee Assignee { get; set; }
    ...
    public required V1alpha1BigQueryReservationAssignmentSpecReservationRef ReservationRef { get; set; }
...
public partial class V1alpha1BigQueryReservationAssignment : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1BigQueryReservationAssignmentSpec>, IStatus<V1alpha1BigQueryReservationAssignmentStatus?>
{
    ...
    public required V1alpha1BigQueryReservationAssignmentSpec Spec { get; set; }
