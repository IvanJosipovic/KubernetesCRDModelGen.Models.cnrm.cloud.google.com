...
public partial class V1alpha1VMwareEnginePrivateCloudList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1VMwareEnginePrivateCloud>
{
    ...
    public string Kind { get; set; } = "VMwareEnginePrivateCloudList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1VMwareEnginePrivateCloud objects.</summary>
...
public partial class V1alpha1VMwareEnginePrivateCloudSpecManagementCluster
{
    ...
    public required IList<V1alpha1VMwareEnginePrivateCloudSpecManagementClusterNodeTypeConfigs> NodeTypeConfigs { get; set; }
}
...
public partial class V1alpha1VMwareEnginePrivateCloudSpecNetworkConfig
{
    ...
    public required string ManagementCIDR { get; set; }
...
public partial class V1alpha1VMwareEnginePrivateCloudSpec
{
    ...
    public required V1alpha1VMwareEnginePrivateCloudSpecManagementCluster ManagementCluster { get; set; }

    /// <summary>Required. Network configuration of the private cloud.</summary>
    [JsonPropertyName("networkConfig")]
    public required V1alpha1VMwareEnginePrivateCloudSpecNetworkConfig NetworkConfig { get; set; }

    /// <summary>The Project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public required V1alpha1VMwareEnginePrivateCloudSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1VMwareEnginePrivateCloud : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1VMwareEnginePrivateCloudSpec>, IStatus<V1alpha1VMwareEnginePrivateCloudStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "VMwareEnginePrivateCloud";
    ...
    public required V1alpha1VMwareEnginePrivateCloudSpec Spec { get; set; }
