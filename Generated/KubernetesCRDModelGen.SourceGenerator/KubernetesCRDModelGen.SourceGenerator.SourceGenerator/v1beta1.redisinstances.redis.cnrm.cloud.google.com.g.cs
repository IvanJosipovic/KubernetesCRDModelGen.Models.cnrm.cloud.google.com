...
/// <summary>RedisInstance is the Schema for the RedisInstance API</summary>
...
public partial class V1beta1RedisInstanceList : IKubernetesObject<V1ListMeta>, IItems<V1beta1RedisInstance>
{
    ...
    public string Kind { get; set; } = "RedisInstanceList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1RedisInstance objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1RedisInstance> Items { get; set; }
}
...
public partial class V1beta1RedisInstanceSpecMaintenancePolicyWeeklyMaintenanceWindow
{
    ...
    public required V1beta1RedisInstanceSpecMaintenancePolicyWeeklyMaintenanceWindowStartTime StartTime { get; set; }
}
...
public partial class V1beta1RedisInstanceSpec
{
    ...
    public required long MemorySizeGb { get; set; }
...
{
    /// <summary>Conditions represent the latest available observations of the RedisInstance&apos;s current state.</summary>
    ...
    public long? ReadEndpointPort { get; set; }
...
public partial class V1beta1RedisInstance : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1RedisInstanceSpec>, IStatus<V1beta1RedisInstanceStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "RedisInstance";
    ...
    public required V1beta1RedisInstanceSpec Spec { get; set; }
