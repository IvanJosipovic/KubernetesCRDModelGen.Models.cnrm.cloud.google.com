...
public partial class V1alpha1ConfigDeliveryResourceBundleList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ConfigDeliveryResourceBundle>
{
    ...
    public const string KubeKind = "ConfigDeliveryResourceBundleList";
    public const string KubeGroup = "configdelivery.cnrm.cloud.google.com";
    public const string KubePluralName = "configdeliveryresourcebundles";
    ...
    public string Kind { get; set; } = "ConfigDeliveryResourceBundleList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1ConfigDeliveryResourceBundle objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1ConfigDeliveryResourceBundle> Items { get; set; }
}
...
{
    /// <summary>Optional. Human readable description of the `ResourceBundle`.</summary>
    ...
    public required V1alpha1ConfigDeliveryResourceBundleSpecProjectRef ProjectRef { get; set; }

    /// <summary>The ConfigDeliveryResourceBundle name. If not given, the metadata.name will be used.</summary>
...
{
    /// <summary>Output only. Time `ResourceBundle` was created.</summary>
    [JsonPropertyName("createTime")]
    public string? CreateTime { get; set; }

    /// <summary>Output only. Time `ResourceBundle` was last updated.</summary>
...
public partial class V1alpha1ConfigDeliveryResourceBundleStatus
{
    ...
    public IList<V1alpha1ConfigDeliveryResourceBundleStatusConditions>? Conditions { get; set; }

    /// <summary>A unique specifier for the ConfigDeliveryResourceBundle resource in GCP.</summary>
    ...
    public V1alpha1ConfigDeliveryResourceBundleStatusObservedState? ObservedState { get; set; }
}
...
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "ConfigDeliveryResourceBundle";
    public const string KubeGroup = "configdelivery.cnrm.cloud.google.com";
    public const string KubePluralName = "configdeliveryresourcebundles";
    /// <summary>APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources</summary>
    [JsonPropertyName("apiVersion")]
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ConfigDeliveryResourceBundle";
    ...
    public required V1alpha1ConfigDeliveryResourceBundleSpec Spec { get; set; }

    /// <summary>ConfigDeliveryResourceBundleStatus defines the config connector machine state of ConfigDeliveryResourceBundle</summary>
    [JsonPropertyName("status")]
    public V1alpha1ConfigDeliveryResourceBundleStatus? Status { get; set; }
}