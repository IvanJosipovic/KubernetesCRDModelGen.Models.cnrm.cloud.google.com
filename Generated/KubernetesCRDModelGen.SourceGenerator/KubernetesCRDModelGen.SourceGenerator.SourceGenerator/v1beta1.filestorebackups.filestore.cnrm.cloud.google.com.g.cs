...
public partial class V1beta1FilestoreBackupList : IKubernetesObject<V1ListMeta>, IItems<V1beta1FilestoreBackup>
{
    ...
    public string ApiVersion { get; set; } = "filestore.cnrm.cloud.google.com/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "FilestoreBackupList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1FilestoreBackup objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1FilestoreBackup> Items { get; set; }
}
...
public partial class V1beta1FilestoreBackupSpec
{
    ...
    public required V1beta1FilestoreBackupSpecProjectRef ProjectRef { get; set; }
    ...
    public required string SourceFileShare { get; set; }

    /// <summary>Immutable.</summary>
    [JsonPropertyName("sourceInstanceRef")]
    public required V1beta1FilestoreBackupSpecSourceInstanceRef SourceInstanceRef { get; set; }
}
...
public partial class V1beta1FilestoreBackup : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1FilestoreBackupSpec>, IStatus<V1beta1FilestoreBackupStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "FilestoreBackup";
    ...
    public required V1beta1FilestoreBackupSpec Spec { get; set; }
