...
public partial class V1beta1SecretManagerSecretList : IKubernetesObject<V1ListMeta>, IItems<V1beta1SecretManagerSecret>
{
    ...
    public string ApiVersion { get; set; } = "secretmanager.cnrm.cloud.google.com/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "SecretManagerSecretList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1SecretManagerSecret objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1SecretManagerSecret> Items { get; set; }
}
...
public partial class V1beta1SecretManagerSecretSpecReplicationAutoCustomerManagedEncryption
{
    ...
    public required V1beta1SecretManagerSecretSpecReplicationAutoCustomerManagedEncryptionKmsKeyRef KmsKeyRef { get; set; }
}
...
public partial class V1beta1SecretManagerSecretSpecReplicationUserManaged
{
    ...
    public required IList<V1beta1SecretManagerSecretSpecReplicationUserManagedReplicas> Replicas { get; set; }
}
...
public partial class V1beta1SecretManagerSecret : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1SecretManagerSecretSpec?>, IStatus<V1beta1SecretManagerSecretStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "SecretManagerSecret";
