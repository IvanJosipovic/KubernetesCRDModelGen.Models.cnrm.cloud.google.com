...
public partial class V1alpha1ComputeInstanceGroupNamedPortList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ComputeInstanceGroupNamedPort>
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "ComputeInstanceGroupNamedPortList";
    ...
    public string Kind { get; set; } = "ComputeInstanceGroupNamedPortList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1ComputeInstanceGroupNamedPort objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1ComputeInstanceGroupNamedPort> Items { get; set; }
}
...
public partial class V1alpha1ComputeInstanceGroupNamedPortSpec
{
    ...
    public required V1alpha1ComputeInstanceGroupNamedPortSpecGroupRef GroupRef { get; set; }
    ...
    public required V1alpha1ComputeInstanceGroupNamedPortSpecProjectRef ProjectRef { get; set; }

    /// <summary>Immutable. Optional. The name of the resource. Used for creation and acquisition. When unset, the value of `metadata.name` is used as the default.</summary>
    [JsonPropertyName("resourceID")]
    public string? ResourceID { get; set; }

    /// <summary>Immutable. The zone of the instance group.</summary>
...
public partial class V1alpha1ComputeInstanceGroupNamedPort : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1ComputeInstanceGroupNamedPortSpec>, IStatus<V1alpha1ComputeInstanceGroupNamedPortStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ComputeInstanceGroupNamedPort";
    ...
    public required V1alpha1ComputeInstanceGroupNamedPortSpec Spec { get; set; }
