...
public partial class V1beta1BigQueryConnectionConnectionList : IKubernetesObject<V1ListMeta>, IItems<V1beta1BigQueryConnectionConnection>
{
    ...
    public string ApiVersion { get; set; } = "bigqueryconnection.cnrm.cloud.google.com/v1beta1";
    ...
    /// <summary>List of V1beta1BigQueryConnectionConnection objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1BigQueryConnectionConnection> Items { get; set; }
}
...
public partial class V1beta1BigQueryConnectionConnectionSpecAws
{
    ...
    public required V1beta1BigQueryConnectionConnectionSpecAwsAccessRole AccessRole { get; set; }
}
...
public partial class V1beta1BigQueryConnectionConnectionSpecCloudSQL
{
    ...
    public required V1beta1BigQueryConnectionConnectionSpecCloudSQLCredential Credential { get; set; }

    /// <summary>Reference to the SQL Database.</summary>
    [JsonPropertyName("databaseRef")]
    public required V1beta1BigQueryConnectionConnectionSpecCloudSQLDatabaseRef DatabaseRef { get; set; }

    /// <summary>Reference to the Cloud SQL instance ID.</summary>
    [JsonPropertyName("instanceRef")]
    public required V1beta1BigQueryConnectionConnectionSpecCloudSQLInstanceRef InstanceRef { get; set; }
...
public partial class V1beta1BigQueryConnectionConnectionSpecCloudSpanner
{
    /// <summary>Reference to a spanner database ID.</summary>
    [JsonPropertyName("databaseRef")]
    public required V1beta1BigQueryConnectionConnectionSpecCloudSpannerDatabaseRef DatabaseRef { get; set; }
...
public partial class V1beta1BigQueryConnectionConnectionSpec
{
    ...
    public required V1beta1BigQueryConnectionConnectionSpecProjectRef ProjectRef { get; set; }
