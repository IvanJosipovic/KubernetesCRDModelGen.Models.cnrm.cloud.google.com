...
public partial class V1alpha1MetastoreFederationList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1MetastoreFederation>
{
    ...
    public string Kind { get; set; } = "MetastoreFederationList";
...
{
    [EnumMember(Value = "BIGQUERY"), JsonStringEnumMemberName("BIGQUERY")]
    BIGQUERY,
    [EnumMember(Value = "DATAPROC_METASTORE"), JsonStringEnumMemberName("DATAPROC_METASTORE")]
    DATAPROCMETASTORE
}
...
public partial class V1alpha1MetastoreFederationSpecBackendMetastores
{
    ...
    public V1alpha1MetastoreFederationSpecBackendMetastoresMetastoreTypeEnum? MetastoreType { get; set; }
...
public partial class V1alpha1MetastoreFederation : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1MetastoreFederationSpec>, IStatus<V1alpha1MetastoreFederationStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "MetastoreFederation";
    ...
    public required V1alpha1MetastoreFederationSpec Spec { get; set; }
