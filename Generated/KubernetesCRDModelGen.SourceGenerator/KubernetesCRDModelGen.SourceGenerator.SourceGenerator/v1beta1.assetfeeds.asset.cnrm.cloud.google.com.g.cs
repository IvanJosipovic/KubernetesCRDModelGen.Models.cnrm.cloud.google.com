...
public partial class V1beta1AssetFeedList : IKubernetesObject<V1ListMeta>, IItems<V1beta1AssetFeed>
{
    ...
    public string Kind { get; set; } = "AssetFeedList";
...
public partial class V1beta1AssetFeedSpecFeedOutputConfigPubsubDestination
{
    ...
    public V1beta1AssetFeedSpecFeedOutputConfigPubsubDestinationTopicRef? TopicRef { get; set; }
}
...
public partial class V1beta1AssetFeedSpecFeedOutputConfig
{
    ...
    public V1beta1AssetFeedSpecFeedOutputConfigPubsubDestination? PubsubDestination { get; set; }
}
...
public partial class V1beta1AssetFeedSpec
{
    ...
    public V1beta1AssetFeedSpecCondition? Condition { get; set; }
    ...
    public required V1beta1AssetFeedSpecFeedOutputConfig FeedOutputConfig { get; set; }

    /// <summary>The Folder that contains this resource.</summary>
    [JsonPropertyName("folderRef")]
    public V1beta1AssetFeedSpecFolderRef? FolderRef { get; set; }

    /// <summary>OrganizationRef represents the Organization that this resource belongs to.</summary>
    [JsonPropertyName("organizationRef")]
    public V1beta1AssetFeedSpecOrganizationRef? OrganizationRef { get; set; }

    /// <summary>The Project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public V1beta1AssetFeedSpecProjectRef? ProjectRef { get; set; }
...
public partial class V1beta1AssetFeedStatus
{
    ...
    public IList<V1beta1AssetFeedStatusConditions>? Conditions { get; set; }
...
public partial class V1beta1AssetFeed : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1AssetFeedSpec>, IStatus<V1beta1AssetFeedStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "AssetFeed";
    ...
    public required V1beta1AssetFeedSpec Spec { get; set; }

    /// <summary>AssetFeedStatus defines the config connector machine state of AssetFeed</summary>
    [JsonPropertyName("status")]
    public V1beta1AssetFeedStatus? Status { get; set; }
}