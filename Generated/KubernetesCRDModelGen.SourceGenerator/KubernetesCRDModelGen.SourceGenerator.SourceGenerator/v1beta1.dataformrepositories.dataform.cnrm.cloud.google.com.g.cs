...
public partial class V1beta1DataformRepositoryList : IKubernetesObject<V1ListMeta>, IItems<V1beta1DataformRepository>
{
    ...
    public string ApiVersion { get; set; } = "dataform.cnrm.cloud.google.com/v1beta1";
    ...
    /// <summary>List of V1beta1DataformRepository objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1DataformRepository> Items { get; set; }
}
...
public partial class V1beta1DataformRepositorySpecGitRemoteSettingsSshAuthenticationConfig
{
    ...
    public required V1beta1DataformRepositorySpecGitRemoteSettingsSshAuthenticationConfigUserPrivateKeySecretVersionRef UserPrivateKeySecretVersionRef { get; set; }
}
...
public partial class V1beta1DataformRepositorySpec
{
    ...
    public required V1beta1DataformRepositorySpecProjectRef ProjectRef { get; set; }
...
public partial class V1beta1DataformRepository : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1DataformRepositorySpec>, IStatus<V1beta1DataformRepositoryStatus?>
{
    ...
    public required V1beta1DataformRepositorySpec Spec { get; set; }
