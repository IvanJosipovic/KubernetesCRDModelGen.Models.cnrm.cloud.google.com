...
public partial class V1beta1StorageTransferJobList : IKubernetesObject<V1ListMeta>, IItems<V1beta1StorageTransferJob>
{
    ...
    public string ApiVersion { get; set; } = "storagetransfer.cnrm.cloud.google.com/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "StorageTransferJobList";
...
public partial class V1beta1StorageTransferJobSpecNotificationConfig
{
    ...
    public required V1beta1StorageTransferJobSpecNotificationConfigTopicRef TopicRef { get; set; }
}
...
public partial class V1beta1StorageTransferJobSpecSchedule
{
    ...
    public required V1beta1StorageTransferJobSpecScheduleScheduleStartDate ScheduleStartDate { get; set; }
...
public partial class V1beta1StorageTransferJobSpecTransferSpecAwsS3DataSourceAwsAccessKey
{
    ...
    public required V1beta1StorageTransferJobSpecTransferSpecAwsS3DataSourceAwsAccessKeyAccessKeyId AccessKeyId { get; set; }

    /// <summary>AWS Secret Access Key.</summary>
    [JsonPropertyName("secretAccessKey")]
    public required V1beta1StorageTransferJobSpecTransferSpecAwsS3DataSourceAwsAccessKeySecretAccessKey SecretAccessKey { get; set; }
}
...
public partial class V1beta1StorageTransferJobSpecTransferSpecAzureBlobStorageDataSourceAzureCredentials
{
    ...
    public required V1beta1StorageTransferJobSpecTransferSpecAzureBlobStorageDataSourceAzureCredentialsSasToken SasToken { get; set; }
}
...
public partial class V1beta1StorageTransferJobSpecTransferSpecAzureBlobStorageDataSource
{
    ...
    public required V1beta1StorageTransferJobSpecTransferSpecAzureBlobStorageDataSourceAzureCredentials AzureCredentials { get; set; }
...
public partial class V1beta1StorageTransferJobSpecTransferSpecGcsDataSink
{
    ...
    public required V1beta1StorageTransferJobSpecTransferSpecGcsDataSinkBucketRef BucketRef { get; set; }
...
{
    [JsonPropertyName("bucketRef")]
    public required V1beta1StorageTransferJobSpecTransferSpecGcsDataSourceBucketRef BucketRef { get; set; }
...
public partial class V1beta1StorageTransferJobSpecTransferSpecHttpDataSource
{
    ...
    public required string ListUrl { get; set; }
}
...
public partial class V1beta1StorageTransferJob : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1StorageTransferJobSpec>, IStatus<V1beta1StorageTransferJobStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "StorageTransferJob";
    ...
    public required V1beta1StorageTransferJobSpec Spec { get; set; }
