...
public partial class V1beta1ManagedKafkaClusterList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ManagedKafkaCluster>
{
    ...
    public string ApiVersion { get; set; } = "managedkafka.cnrm.cloud.google.com/v1beta1";
    ...
    /// <summary>List of V1beta1ManagedKafkaCluster objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ManagedKafkaCluster> Items { get; set; }
}
...
public partial class V1beta1ManagedKafkaClusterSpecGcpConfigAccessConfigNetworkConfigs
{
    ...
    public required V1beta1ManagedKafkaClusterSpecGcpConfigAccessConfigNetworkConfigsSubnetworkRef SubnetworkRef { get; set; }
}
...
public partial class V1beta1ManagedKafkaClusterSpecGcpConfigAccessConfig
{
    ...
    public required IList<V1beta1ManagedKafkaClusterSpecGcpConfigAccessConfigNetworkConfigs> NetworkConfigs { get; set; }
}
...
public partial class V1beta1ManagedKafkaClusterSpecGcpConfig
{
    ...
    public required V1beta1ManagedKafkaClusterSpecGcpConfigAccessConfig AccessConfig { get; set; }
...
public partial class V1beta1ManagedKafkaClusterSpec
{
    ...
    public required V1beta1ManagedKafkaClusterSpecCapacityConfig CapacityConfig { get; set; }

    /// <summary>Required. Configuration properties for a Kafka cluster deployed to Google Cloud Platform.</summary>
    [JsonPropertyName("gcpConfig")]
    public required V1beta1ManagedKafkaClusterSpecGcpConfig GcpConfig { get; set; }
    ...
    public required V1beta1ManagedKafkaClusterSpecProjectRef ProjectRef { get; set; }
...
public partial class V1beta1ManagedKafkaCluster : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ManagedKafkaClusterSpec>, IStatus<V1beta1ManagedKafkaClusterStatus?>
{
    ...
    public required V1beta1ManagedKafkaClusterSpec Spec { get; set; }
