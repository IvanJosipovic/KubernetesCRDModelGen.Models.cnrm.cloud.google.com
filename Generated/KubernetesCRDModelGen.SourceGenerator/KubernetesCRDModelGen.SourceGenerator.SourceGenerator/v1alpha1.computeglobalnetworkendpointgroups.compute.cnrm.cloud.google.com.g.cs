...
public partial class V1alpha1ComputeGlobalNetworkEndpointGroupList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ComputeGlobalNetworkEndpointGroup>
{
    ...
    public string Kind { get; set; } = "ComputeGlobalNetworkEndpointGroupList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1ComputeGlobalNetworkEndpointGroup objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1ComputeGlobalNetworkEndpointGroup> Items { get; set; }
}
...
public partial class V1alpha1ComputeGlobalNetworkEndpointGroupSpec
{
    ...
    public required string NetworkEndpointType { get; set; }

    /// <summary>The project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public required V1alpha1ComputeGlobalNetworkEndpointGroupSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1ComputeGlobalNetworkEndpointGroup : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1ComputeGlobalNetworkEndpointGroupSpec>, IStatus<V1alpha1ComputeGlobalNetworkEndpointGroupStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ComputeGlobalNetworkEndpointGroup";
    ...
    public required V1alpha1ComputeGlobalNetworkEndpointGroupSpec Spec { get; set; }
