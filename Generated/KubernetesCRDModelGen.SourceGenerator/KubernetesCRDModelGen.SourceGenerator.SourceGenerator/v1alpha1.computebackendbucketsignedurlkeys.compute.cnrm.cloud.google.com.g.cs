...
public partial class V1alpha1ComputeBackendBucketSignedURLKeyList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1ComputeBackendBucketSignedURLKey>
{
    ...
    public string Kind { get; set; } = "ComputeBackendBucketSignedURLKeyList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1ComputeBackendBucketSignedURLKey objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1ComputeBackendBucketSignedURLKey> Items { get; set; }
}
...
public partial class V1alpha1ComputeBackendBucketSignedURLKeySpec
{
    ...
    public required V1alpha1ComputeBackendBucketSignedURLKeySpecBackendBucketRef BackendBucketRef { get; set; }
    ...
    public required V1alpha1ComputeBackendBucketSignedURLKeySpecKeyValue KeyValue { get; set; }

    /// <summary>The project that this resource belongs to.</summary>
    [JsonPropertyName("projectRef")]
    public required V1alpha1ComputeBackendBucketSignedURLKeySpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1ComputeBackendBucketSignedURLKey : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1ComputeBackendBucketSignedURLKeySpec>, IStatus<V1alpha1ComputeBackendBucketSignedURLKeyStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ComputeBackendBucketSignedURLKey";
    ...
    public required V1alpha1ComputeBackendBucketSignedURLKeySpec Spec { get; set; }
