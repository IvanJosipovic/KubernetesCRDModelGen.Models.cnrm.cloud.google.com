...
public partial class V1alpha1HealthcareDatasetList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1HealthcareDataset>
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "HealthcareDatasetList";
    ...
    public string Kind { get; set; } = "HealthcareDatasetList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1HealthcareDataset objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1HealthcareDataset> Items { get; set; }
}
...
public partial class V1alpha1HealthcareDatasetSpec
{
    ...
    public required V1alpha1HealthcareDatasetSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1HealthcareDataset : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1HealthcareDatasetSpec>, IStatus<V1alpha1HealthcareDatasetStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "HealthcareDataset";
    ...
    public required V1alpha1HealthcareDatasetSpec Spec { get; set; }
