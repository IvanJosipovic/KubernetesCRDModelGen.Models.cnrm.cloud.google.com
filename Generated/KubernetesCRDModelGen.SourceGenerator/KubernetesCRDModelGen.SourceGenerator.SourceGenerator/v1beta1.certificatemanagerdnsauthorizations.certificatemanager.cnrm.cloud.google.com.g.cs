...
public partial class V1beta1CertificateManagerDNSAuthorizationList : IKubernetesObject<V1ListMeta>, IItems<V1beta1CertificateManagerDNSAuthorization>
{
    ...
    /// <summary>List of V1beta1CertificateManagerDNSAuthorization objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1CertificateManagerDNSAuthorization> Items { get; set; }
}
...
public partial class V1beta1CertificateManagerDNSAuthorizationSpec
{
    ...
    public required V1beta1CertificateManagerDNSAuthorizationSpecProjectRef ProjectRef { get; set; }
...
public partial class V1beta1CertificateManagerDNSAuthorization : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1CertificateManagerDNSAuthorizationSpec>, IStatus<V1beta1CertificateManagerDNSAuthorizationStatus?>
{
    ...
    public required V1beta1CertificateManagerDNSAuthorizationSpec Spec { get; set; }
