...
public partial class V1beta1ApigeeOrganizationList : IKubernetesObject<V1ListMeta>, IItems<V1beta1ApigeeOrganization>
{
    ...
    public string Kind { get; set; } = "ApigeeOrganizationList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1ApigeeOrganization objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1ApigeeOrganization> Items { get; set; }
}
...
public partial class V1beta1ApigeeOrganizationSpec
{
    ...
    public required string AnalyticsRegion { get; set; }
    ...
    public required V1beta1ApigeeOrganizationSpecProjectRef ProjectRef { get; set; }
...
public partial class V1beta1ApigeeOrganization : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1ApigeeOrganizationSpec>, IStatus<V1beta1ApigeeOrganizationStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "ApigeeOrganization";
    ...
    public required V1beta1ApigeeOrganizationSpec Spec { get; set; }
