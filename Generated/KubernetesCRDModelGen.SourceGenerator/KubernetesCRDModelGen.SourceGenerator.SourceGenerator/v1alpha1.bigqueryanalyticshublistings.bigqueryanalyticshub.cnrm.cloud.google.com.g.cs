...
public partial class V1alpha1BigQueryAnalyticsHubListingList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1BigQueryAnalyticsHubListing>
{
    public const string KubeApiVersion = "v1alpha1";
    public const string KubeKind = "BigQueryAnalyticsHubListingList";
    ...
    public string ApiVersion { get; set; } = "bigqueryanalyticshub.cnrm.cloud.google.com/v1alpha1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "BigQueryAnalyticsHubListingList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1BigQueryAnalyticsHubListing objects.</summary>
    [JsonPropertyName("items")]
    public IList<V1alpha1BigQueryAnalyticsHubListing>? Items { get; set; }
}
...
public partial class V1alpha1BigQueryAnalyticsHubListingSpecSourceBigQueryDatasetSourceSelectedResources
{
    ...
    public V1alpha1BigQueryAnalyticsHubListingSpecSourceBigQueryDatasetSourceSelectedResourcesTableRef? TableRef { get; set; }
}
...
public partial class V1alpha1BigQueryAnalyticsHubListingSpecSourceBigQueryDatasetSource
{
    ...
    public required V1alpha1BigQueryAnalyticsHubListingSpecSourceBigQueryDatasetSourceDatasetRef DatasetRef { get; set; }
...
public partial class V1alpha1BigQueryAnalyticsHubListingSpec
{
    ...
    public required V1alpha1BigQueryAnalyticsHubListingSpecProjectRef ProjectRef { get; set; }
    ...
    public required V1alpha1BigQueryAnalyticsHubListingSpecSource Source { get; set; }
}
...
public partial class V1alpha1BigQueryAnalyticsHubListing : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1BigQueryAnalyticsHubListingSpec?>, IStatus<V1alpha1BigQueryAnalyticsHubListingStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "BigQueryAnalyticsHubListing";
