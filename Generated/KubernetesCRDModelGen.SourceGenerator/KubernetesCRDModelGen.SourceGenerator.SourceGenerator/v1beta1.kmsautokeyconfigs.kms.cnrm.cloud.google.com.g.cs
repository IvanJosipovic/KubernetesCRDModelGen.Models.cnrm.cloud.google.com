...
public partial class V1beta1KMSAutokeyConfigList : IKubernetesObject<V1ListMeta>, IItems<V1beta1KMSAutokeyConfig>
{
    ...
    /// <summary>List of V1beta1KMSAutokeyConfig objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1KMSAutokeyConfig> Items { get; set; }
}
