...
public partial class V1alpha1BigQueryAnalyticsHubDataExchangeList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1BigQueryAnalyticsHubDataExchange>
{
    ...
    public string Kind { get; set; } = "BigQueryAnalyticsHubDataExchangeList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1BigQueryAnalyticsHubDataExchange objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1BigQueryAnalyticsHubDataExchange> Items { get; set; }
}
...
public partial class V1alpha1BigQueryAnalyticsHubDataExchangeSpec
{
    ...
    public required V1alpha1BigQueryAnalyticsHubDataExchangeSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1BigQueryAnalyticsHubDataExchange : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1BigQueryAnalyticsHubDataExchangeSpec>, IStatus<V1alpha1BigQueryAnalyticsHubDataExchangeStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "BigQueryAnalyticsHubDataExchange";
    ...
    public required V1alpha1BigQueryAnalyticsHubDataExchangeSpec Spec { get; set; }
