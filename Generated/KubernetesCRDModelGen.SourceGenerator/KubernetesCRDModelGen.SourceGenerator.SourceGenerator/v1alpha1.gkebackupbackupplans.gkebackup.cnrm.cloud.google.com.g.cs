...
public partial class V1alpha1GKEBackupBackupPlanList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1GKEBackupBackupPlan>
{
    ...
    public string Kind { get; set; } = "GKEBackupBackupPlanList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1GKEBackupBackupPlan objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1GKEBackupBackupPlan> Items { get; set; }
}
...
public partial class V1alpha1GKEBackupBackupPlanSpecBackupScheduleRpoConfigExclusionWindows
{
    ...
    public required V1alpha1GKEBackupBackupPlanSpecBackupScheduleRpoConfigExclusionWindowsStartTime StartTime { get; set; }
}
...
public partial class V1alpha1GKEBackupBackupPlanSpec
{
    ...
    public required V1alpha1GKEBackupBackupPlanSpecClusterRef ClusterRef { get; set; }
    ...
    public required V1alpha1GKEBackupBackupPlanSpecProjectRef ProjectRef { get; set; }
...
public partial class V1alpha1GKEBackupBackupPlan : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1GKEBackupBackupPlanSpec>, IStatus<V1alpha1GKEBackupBackupPlanStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "GKEBackupBackupPlan";
    ...
    public required V1alpha1GKEBackupBackupPlanSpec Spec { get; set; }
