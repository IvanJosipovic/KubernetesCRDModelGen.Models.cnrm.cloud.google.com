...
public partial class V1alpha1GKEBackupRestoreList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1GKEBackupRestore>
{
    ...
    public string Kind { get; set; } = "GKEBackupRestoreList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1GKEBackupRestore objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1GKEBackupRestore> Items { get; set; }
}
...
public partial class V1alpha1GKEBackupRestoreSpec
{
    ...
    public required V1alpha1GKEBackupRestoreSpecRestorePlanRef RestorePlanRef { get; set; }
...
public partial class V1alpha1GKEBackupRestoreStatusObservedStateRestoreConfigRestoreOrderGroupKindDependencies
{
    ...
    public required V1alpha1GKEBackupRestoreStatusObservedStateRestoreConfigRestoreOrderGroupKindDependenciesRequiring Requiring { get; set; }

    /// <summary>Required. The satisfying group kind must be restored first in order to satisfy the dependency.</summary>
    [JsonPropertyName("satisfying")]
    public required V1alpha1GKEBackupRestoreStatusObservedStateRestoreConfigRestoreOrderGroupKindDependenciesSatisfying Satisfying { get; set; }
}
...
public partial class V1alpha1GKEBackupRestoreStatusObservedStateRestoreConfigTransformationRules
{
    ...
    public required IList<V1alpha1GKEBackupRestoreStatusObservedStateRestoreConfigTransformationRulesFieldActions> FieldActions { get; set; }
...
public partial class V1alpha1GKEBackupRestore : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1GKEBackupRestoreSpec>, IStatus<V1alpha1GKEBackupRestoreStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "GKEBackupRestore";
    ...
    public required V1alpha1GKEBackupRestoreSpec Spec { get; set; }
