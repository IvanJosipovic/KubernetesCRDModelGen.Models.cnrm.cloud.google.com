...
public partial class V1alpha1CloudDMSPrivateConnectionList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1CloudDMSPrivateConnection>
{
    ...
    public string Kind { get; set; } = "CloudDMSPrivateConnectionList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1CloudDMSPrivateConnection objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1CloudDMSPrivateConnection> Items { get; set; }
}
...
public partial class V1alpha1CloudDMSPrivateConnection : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1CloudDMSPrivateConnectionSpec>, IStatus<V1alpha1CloudDMSPrivateConnectionStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "CloudDMSPrivateConnection";
    ...
    public required V1alpha1CloudDMSPrivateConnectionSpec Spec { get; set; }
