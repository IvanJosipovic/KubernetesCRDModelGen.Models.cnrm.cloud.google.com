...
public partial class V1alpha1PrivilegedAccessManagerEntitlementList : IKubernetesObject<V1ListMeta>, IItems<V1alpha1PrivilegedAccessManagerEntitlement>
{
    ...
    public string ApiVersion { get; set; } = "privilegedaccessmanager.cnrm.cloud.google.com/v1alpha1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "PrivilegedAccessManagerEntitlementList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1alpha1PrivilegedAccessManagerEntitlement objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1alpha1PrivilegedAccessManagerEntitlement> Items { get; set; }
}
...
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1alpha1PrivilegedAccessManagerEntitlementSpecApprovalWorkflowManualApprovalsStepsApprovers
{
    ...
    public required IList<string> Principals { get; set; }
}

/// <summary>Step represents a logical step in a manual approval workflow.</summary>
[global::System.CodeDom.Compiler.GeneratedCode("KubernetesCRDModelGen", "1.5.3+0316f97acf12de380316633df08e7f13a064978d")]
[global::System.Diagnostics.CodeAnalysis.ExcludeFromCodeCoverage]
public partial class V1alpha1PrivilegedAccessManagerEntitlementSpecApprovalWorkflowManualApprovalsSteps
{
    ...
    public required int ApprovalsNeeded { get; set; }
    ...
    public IList<V1alpha1PrivilegedAccessManagerEntitlementSpecApprovalWorkflowManualApprovalsStepsApprovers>? Approvers { get; set; }
}
...
public partial class V1alpha1PrivilegedAccessManagerEntitlementSpecApprovalWorkflowManualApprovals
{
    ...
    public IList<V1alpha1PrivilegedAccessManagerEntitlementSpecApprovalWorkflowManualApprovalsSteps>? Steps { get; set; }
}
...
public partial class V1alpha1PrivilegedAccessManagerEntitlementSpecApprovalWorkflow
{
    ...
    public required V1alpha1PrivilegedAccessManagerEntitlementSpecApprovalWorkflowManualApprovals ManualApprovals { get; set; }
}
...
public partial class V1alpha1PrivilegedAccessManagerEntitlementSpecPrivilegedAccessGcpIAMAccess
{
    ...
    public required IList<V1alpha1PrivilegedAccessManagerEntitlementSpecPrivilegedAccessGcpIAMAccessRoleBindings> RoleBindings { get; set; }
}
...
public partial class V1alpha1PrivilegedAccessManagerEntitlementSpecPrivilegedAccess
{
    ...
    public required V1alpha1PrivilegedAccessManagerEntitlementSpecPrivilegedAccessGcpIAMAccess GcpIAMAccess { get; set; }
}
...
public partial class V1alpha1PrivilegedAccessManagerEntitlementSpec
{
    ...
    public required IList<V1alpha1PrivilegedAccessManagerEntitlementSpecEligibleUsers> EligibleUsers { get; set; }
    ...
    public required string MaxRequestDuration { get; set; }
    ...
    public required V1alpha1PrivilegedAccessManagerEntitlementSpecPrivilegedAccess PrivilegedAccess { get; set; }
...
public partial class V1alpha1PrivilegedAccessManagerEntitlement : IKubernetesObject<V1ObjectMeta>, ISpec<V1alpha1PrivilegedAccessManagerEntitlementSpec?>, IStatus<V1alpha1PrivilegedAccessManagerEntitlementStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "PrivilegedAccessManagerEntitlement";
