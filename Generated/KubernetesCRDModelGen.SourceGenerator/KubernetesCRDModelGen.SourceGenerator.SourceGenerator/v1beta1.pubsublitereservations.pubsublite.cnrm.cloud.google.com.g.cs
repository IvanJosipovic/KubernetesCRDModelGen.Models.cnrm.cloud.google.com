...
public partial class V1beta1PubSubLiteReservationList : IKubernetesObject<V1ListMeta>, IItems<V1beta1PubSubLiteReservation>
{
    ...
    public string ApiVersion { get; set; } = "pubsublite.cnrm.cloud.google.com/v1beta1";

    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "PubSubLiteReservationList";

    /// <summary>ListMeta describes metadata that synthetic resources must have, including lists and various status objects. A resource may have only one of {ObjectMeta, ListMeta}.</summary>
    [JsonPropertyName("metadata")]
    public V1ListMeta? Metadata { get; set; }

    /// <summary>List of V1beta1PubSubLiteReservation objects.</summary>
    [JsonPropertyName("items")]
    public required IList<V1beta1PubSubLiteReservation> Items { get; set; }
}
...
public partial class V1beta1PubSubLiteReservationSpec
{
    ...
    public required V1beta1PubSubLiteReservationSpecProjectRef ProjectRef { get; set; }
    ...
    public required int ThroughputCapacity { get; set; }
}
...
public partial class V1beta1PubSubLiteReservation : IKubernetesObject<V1ObjectMeta>, ISpec<V1beta1PubSubLiteReservationSpec>, IStatus<V1beta1PubSubLiteReservationStatus?>
{
    ...
    /// <summary>Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds</summary>
    [JsonPropertyName("kind")]
    public string Kind { get; set; } = "PubSubLiteReservation";
    ...
    public required V1beta1PubSubLiteReservationSpec Spec { get; set; }
